...
class AssetService {
  ...
  constructor() {
    ...
    this.loadAssets();
    console.log(
      'AssetService constructor completed, final asset count:',
      this.assets.length
    );
  }
  ...
  private initializeDefaultAssets() {
    this.assets = [
      ...
      },
      {
        ...
        image:
          'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=192&fit=crop&crop=center',
        description:
      ...
      },
      {
        ...
        image:
          'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=400&h=192&fit=crop&crop=center',
        description:
          'Premium commercial office space in Dubai Marina with high rental yields.',
        status: 'active',
      ...
      },
      {
        ...
        image:
          'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400&h=192&fit=crop&crop=center',
        description:
          'Luxury residential properties along Abu Dhabi Corniche with waterfront views.',
        status: 'active',
      ...
      },
      {
        ...
        image:
          'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=400&h=192&fit=crop&crop=center',
        description:
          'Premium gold and precious metals inventory from Dubai Gold Souk.',
        status: 'active',
      ...
      },
      {
        ...
        image:
          'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&h=192&fit=crop&crop=center',
        description:
          'Traditional textiles and fabrics from Sharjah textile markets.',
        status: 'active',
      ...
      },
      {
        ...
        image:
          'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=400&h=192&fit=crop&crop=center',
        description:
          'Secure vault storage for gold and precious metals at DIFC.',
        status: 'active',
      ...
      },
      {
        ...
        image:
          'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=400&h=192&fit=crop&crop=center',
        description:
          'High-security vault for diamonds and precious stones at ADGM.',
        status: 'active',
  ...
  async getAssetById(id: string): Promise<Asset | null> {
    ...
    console.log(
      'Available assets:',
      this.assets.map(a => ({ id: a.id, name: a.name }))
    );
  ...
  async getAssetStats(): Promise<{
    ...
    const byRisk = activeAssets.reduce(
      (acc, asset) => {
