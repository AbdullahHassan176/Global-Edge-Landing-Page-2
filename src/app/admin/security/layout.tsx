...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Security management dashboard for administrators. Monitor security events, manage access controls, and configure security settings.',
    keywords: 'admin security, security management, access control, security monitoring, admin dashboard, security settings, platform security',
    ...
    openGraph: {
      ...
      type: 'website',
      images: [{ url: 'https://theglobaledge.io/og-admin-security.jpg', width: 1200, height: 630, alt: 'Admin Security | Security Management | The Global Edge' }]
    },
    twitter: {
      ...baseMeta.twitter,
      title: 'Admin Security | Security Management | The Global Edge',
...
export default function AdminSecurityLayout({ children }: { children: React.ReactNode }) {
  const jsonLd = {
        ...
        "mainEntity": {
          ...
          "description": "Administrative security management system for monitoring security events, managing access controls, and configuring security settings",
          "author": {
            "@type": "Organization",
