          ...
          <div className='max-w-7xl mx-auto px-6 lg:px-8'>
            ...
            <div className='text-center'>
              ...
              <p className='text-xl text-white/90 max-w-3xl mx-auto'>
                Monitor security events, access logs, and system integrity
                across the platform.
              </p>
            </div>
          </div>
              ...
              <div className='bg-white rounded-2xl p-6 shadow-lg'>
                <div className='flex items-center'>
                  ...
                  <div>
                    <h3 className='text-2xl font-poppins font-bold text-charcoal'>
                      {
                        securityEvents.filter(e => e.status === 'investigating')
                          .length
                      }
                    </h3>
                  ...
                  <div className='flex flex-wrap gap-4'>
                    {[
                      ...
                      },
                      {
                        key: 'high',
                        label: 'High',
                        count: securityEvents.filter(e => e.severity === 'high')
                          .length,
                      },
                      {
                        key: 'medium',
                      ...
                      },
                      {
                        key: 'low',
                        label: 'Low',
                        count: securityEvents.filter(e => e.severity === 'low')
                          .length,
                      },
                    ].map(({ key, label, count }) => (
                      <button
                ...
                <div className='bg-white rounded-2xl p-6 shadow-lg'>
                  ...
                  <div className='space-y-4'>
                    <div className='flex items-center justify-between'>
                      ...
                      <span
                        className={`font-semibold ${getHealthColor(systemHealth.status)}`}
                      >
                ...
                <div className='bg-white rounded-2xl p-6 shadow-lg'>
                  ...
                  <div className='space-y-4'>
                    ...
                    <div className='flex items-center justify-between'>
                      ...
                      <span className='font-semibold text-charcoal'>
                        {formatDate(systemHealth.sslExpiry)}
                      </span>
                    </div>
                    <div className='flex items-center justify-between'>
              ...
              <div className='space-y-6'>
                <div className='flex items-center space-x-4'>
                  ...
                  >
                    <Icon
                      name={
                        selectedEvent.type === 'failed_login'
                  ...
                  <div>
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-sm font-semibold ${getSeverityColor(selectedEvent.severity)}`}
                    >
                ...
                <div>
                  ...
                  <p className='text-charcoal bg-gray-50 p-4 rounded-lg'>
