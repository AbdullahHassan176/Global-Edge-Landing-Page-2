...
export default function WaitlistManagementPage() {
  ...
  const [filter, setFilter] = useState<
    'all' | 'new' | 'contacted' | 'qualified' | 'rejected'
  >('all');
  ...
  const loadSubmissions = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        console.log(
          '✅ Loaded submissions from database:',
                  ...
                  <tbody className='bg-white divide-y divide-gray-200'>
                    {filteredSubmissions.map(submission => (
                      <tr key={submission.id}>
                        ...
                        <td className='px-6 py-4 whitespace-nowrap'>
                          <div className='text-sm text-charcoal'>
                            {getInvestorTypeLabel(submission.investorType)}
                          </div>
                          <div className='text-sm text-gray-500'>
                            {submission.tokenInterest}
                          </div>
                        </td>
                        ...
                        <td className='px-6 py-4 whitespace-nowrap text-right text-sm font-medium'>
                          ...
                          <select
                            ...
                            onChange={e =>
                              handleUpdateStatus(submission.id, e.target.value)
                            }
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700'>
                  <div>
                    ...
                    <p>
                      ...
                      {getInvestorTypeLabel(selectedSubmission.investorType)}
                    </p>
                  </div>
                  <div>
                    <p>
                    ...
                    <p>
                      <strong>Token Interest:</strong>{' '}
                      {selectedSubmission.tokenInterest}
                    </p>
                    <p>
                      <strong>Heard From:</strong>{' '}
                      {selectedSubmission.heardFrom}
                    </p>
                    <p>
                    ...
                    <p>
                      <strong>IP Address:</strong> {selectedSubmission.ip}
                    </p>
                  </div>
                </div>
