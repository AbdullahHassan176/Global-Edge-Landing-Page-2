...
function SettingsDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<
    'general' | 'email' | 'security' | 'api' | 'integrations'
  >('general');
  ...
  const saveSettings = async () => {
    try {
      ...
      for (const integration of allIntegrations) {
        const success = settingsService.updateIntegration(
          integration.id,
          integration
        );
        if (!success) {
          ...
          <div className='max-w-7xl mx-auto px-6 lg:px-8'>
            <div className='text-center mb-8'>
              ...
              <p className='text-xl text-white/90 max-w-3xl mx-auto'>
                System settings and configuration management for The Global Edge
                platform.
              </p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-xl text-white/90 max-w-3xl mx-auto'>
                Configure system settings, integrations, and platform
                preferences with real-time validation and comprehensive
                management tools.
              </p>
            </div>
          </div>
          ...
          <div className='max-w-7xl mx-auto px-6 lg:px-8'>
              ...
              {[
                {
                  key: 'general',
                  label: 'General',
                  count: settings.filter(s => s.category === 'General').length,
                  icon: 'cog',
                },
                {
                  key: 'email',
                  label: 'Email',
                  count: settings.filter(s => s.category === 'Email').length,
                  icon: 'envelope',
                },
                {
                  key: 'security',
                  label: 'Security',
                  count: settings.filter(s => s.category === 'Security').length,
                  icon: 'shield-halved',
                },
                {
                  key: 'api',
                  label: 'API',
                  count: settings.filter(s => s.category === 'API').length,
                  icon: 'code',
                },
                {
                  key: 'integrations',
                          ...
                          {setting.type === 'boolean' && (
                            <label className='relative inline-flex items-center cursor-pointer'>
                              <input
                                ...
                                onChange={e =>
                                  updateSetting(setting.id, e.target.checked)
                                }
                ...
                <div className='bg-white rounded-2xl p-6 shadow-lg'>
                  <div className='flex items-center justify-between mb-6'>
                    <div>
                      ...
                      <p className='text-gray-600 mt-1'>
                        Configure and manage third-party integrations and
                        services
                      </p>
                    </div>
                    <div className='flex items-center space-x-3'>
                        ...
                        <div className='flex items-center justify-between'>
                          <div className='flex items-center space-x-4'>
                            <div className='w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center'>
                              <Icon
                                name={getTypeIcon(integration.type)}
            ...
            <div className='mt-8 bg-red-50 border border-red-200 rounded-2xl p-8'>
              <div className='flex items-center mb-6'>
                ...
                />
                <h2 className='text-2xl font-poppins font-bold text-red-800'>
                  Danger Zone
                </h2>
              </div>
              <p className='text-red-700 mb-6'>
                These actions are irreversible and can affect your entire
