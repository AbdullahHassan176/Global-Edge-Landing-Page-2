...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Administrative account registration portal for Global Edge platform. Create new admin accounts with proper authorization.',
    keywords: 'admin registration, create admin account, administrative access, admin signup, platform administration, admin onboarding',
    ...
    openGraph: {
      ...
      type: 'website',
      images: [{ url: 'https://theglobaledge.io/og-admin-register.jpg', width: 1200, height: 630, alt: 'Admin Registration | Create Admin Account | The Global Edge' }]
    },
    twitter: {
      ...baseMeta.twitter,
      title: 'Admin Registration | Create Admin Account | The Global Edge',
...
export default function AdminRegisterLayout({ children }: { children: React.ReactNode }) {
  const jsonLd = {
        ...
        "mainEntity": {
          ...
          "description": "Registration portal for creating new administrative accounts with proper authorization",
          "author": {
            "@type": "Organization",
