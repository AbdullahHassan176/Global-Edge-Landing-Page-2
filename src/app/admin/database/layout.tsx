...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Database management and monitoring dashboard for administrators. Monitor Azure Cosmos DB connections and performance.',
    keywords: 'admin database management, database monitoring, Azure Cosmos DB, database administration, system monitoring, admin tools',
    ...
    openGraph: {
      ...
      type: 'website',
      images: [{ url: 'https://theglobaledge.io/og-admin-database.jpg', width: 1200, height: 630, alt: 'Admin Database Management | Database Monitoring | The Global Edge' }]
    },
    twitter: {
      ...baseMeta.twitter,
      title: 'Admin Database Management | Database Monitoring | The Global Edge',
...
export default function AdminDatabaseLayout({ children }: { children: React.ReactNode }) {
  const jsonLd = {
        ...
        "mainEntity": {
          ...
          "description": "Administrative database management and monitoring system for Azure Cosmos DB connections and performance",
          "author": {
            "@type": "Organization",
