...
At Global Edge, we're committed to leading this transformation and providing our investors with access to the world's most promising tokenized real estate opportunities.`,
    excerpt:
      'Explore how tokenized real estate is revolutionizing property investment with increased accessibility, liquidity, and transparency.',
    tags: ['real estate', 'tokenization', 'investment', 'blockchain'],
    featured: true,
    seoTitle: 'Future of Tokenized Real Estate Investments | Global Edge',
    seoDescription:
      'Discover how tokenized real estate is transforming property investment with blockchain technology',
...
Container investments offer a unique opportunity to participate in the global trade ecosystem while generating stable returns. With Global Edge's expertise and infrastructure, investors can access this market with confidence and transparency.`,
    excerpt:
      'Discover the benefits and opportunities of investing in shipping containers as part of a diversified investment portfolio.',
    tags: ['containers', 'logistics', 'investment', 'trade'],
    featured: false,
    seoTitle: 'Container Investment Opportunities | Global Edge',
    seoDescription:
      'Learn about shipping container investment opportunities and how to get started with Global Edge',
  ...
  },
  {
    ...
    category: 'News',
    content:
      'We are excited to announce the launch of our new Dubai Marina property tokenization program...',
  ...
  },
  {
    ...
    category: 'Support',
    content:
      'Step-by-step guide to completing KYC verification on our platform...',
...
function ContentManagementDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<'content' | 'assets' | 'media'>(
    'content'
  );
  const [filter, setFilter] = useState<
    'all' | 'published' | 'draft' | 'archived' | 'pending_review'
  >('all');
  const [typeFilter, setTypeFilter] = useState<
    'all' | 'page' | 'blog' | 'document' | 'announcement' | 'faq'
  >('all');
  ...
  const [sortBy, setSortBy] = useState<'title' | 'date' | 'views' | 'status'>(
    'date'
  );
          ...
          <div className='max-w-7xl mx-auto px-6 lg:px-8'>
            ...
            <div className='text-center'>
              ...
              <p className='text-xl text-white/90 max-w-3xl mx-auto'>
                Manage website content, assets, and marketing materials across
                the platform.
              </p>
            </div>
          </div>
          ...
          <div className='max-w-7xl mx-auto px-6 lg:px-8'>
            <div className='grid md:grid-cols-5 gap-6'>
              <div className='bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 text-center'>
                ...
                <h3 className='text-2xl font-poppins font-bold text-blue-900'>
                  {stats.total}
                </h3>
              ...
              <div className='bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 text-center'>
                ...
                <h3 className='text-2xl font-poppins font-bold text-green-900'>
                  {stats.published}
                </h3>
              ...
              <div className='bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl p-6 text-center'>
                ...
                <h3 className='text-2xl font-poppins font-bold text-yellow-900'>
                  {stats.draft}
                </h3>
              ...
              <div className='bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 text-center'>
                ...
                <h3 className='text-2xl font-poppins font-bold text-purple-900'>
                ...
                {filteredContent.length === 0 && (
                  <div className='text-center py-12'>
                    ...
                    <p className='text-gray-500'>
                      No content matches your current filter criteria.
                    </p>
                  </div>
                )}
              </div>
                    ...
                    <div className='bg-gray-50 rounded-lg p-4 mb-4'>
                      ...
                      <div className='space-y-2 text-sm'>
                        ...
                        <div>
                          ...
                          <span
                            className={`ml-2 px-2 py-1 rounded-full text-xs ${getStatusColor(selectedItem.status)}`}
                          >
                        ...
                        <div>
                          <strong>Views:</strong>{' '}
                          {selectedItem.views?.toLocaleString() || 'N/A'}
                        </div>
                        <div>
                  ...
                  <div>
                      ...
                      <div className='bg-gray-50 rounded-lg p-4 mb-4'>
                        ...
                        <div className='flex flex-wrap gap-2'>
                          {selectedItem.tags.map((tag, index) => (
                            <span
                              key={index}
                              className='px-2 py-1 bg-global-teal text-white rounded text-xs'
                            >
                              {tag}
                            </span>
                          ))}
                    ...
                    {selectedItem.seoTitle && (
                      <div className='bg-gray-50 rounded-lg p-4'>
                        ...
                        <div className='space-y-2 text-sm'>
                          <div>
                            <strong>Title:</strong> {selectedItem.seoTitle}
                          </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  <div>
                    ...
                    <div className='space-y-3 text-sm'>
                      ...
                      <div>
                        <strong>Size:</strong> {selectedAsset.size}
                      </div>
                      <div>
                        <strong>Format:</strong> {selectedAsset.format || 'N/A'}
                      </div>
                      ...
                      {selectedAsset.altText && (
                        <div>
                          <strong>Alt Text:</strong> {selectedAsset.altText}
                        </div>
                      )}
                    </div>
                  </div>
