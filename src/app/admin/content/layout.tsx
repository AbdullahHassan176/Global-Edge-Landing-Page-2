...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Comprehensive content management system for administrators. Manage website content, assets, and marketing materials.',
    keywords:
      'admin content management, CMS dashboard, content management system, website content, marketing materials, admin tools',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://theglobaledge.io/og-admin-content.jpg',
          width: 1200,
          height: 630,
          alt: 'Admin Content Management | CMS Dashboard | The Global Edge',
        },
      ],
    },
    twitter: {
...
export default function AdminContentLayout({
  ...
  const jsonLd = {
    ...
    mainEntity: {
      ...
      description:
        'Administrative content management system for website content, assets, and marketing materials',
      author: {
        '@type': 'Organization',
