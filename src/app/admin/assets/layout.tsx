...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Administrative asset management dashboard. Review, approve, and manage tokenized assets across the platform.',
    keywords:
      'admin asset management, asset approval, tokenized assets, asset review, platform administration, asset oversight',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://theglobaledge.io/og-admin-assets.jpg',
          width: 1200,
          height: 630,
          alt: 'Admin Asset Management | Asset Approval | The Global Edge',
        },
      ],
    },
    twitter: {
...
export default function AdminAssetsLayout({
  children,
}: {
  ...
  const jsonLd = {
    ...
    mainEntity: {
      ...
      description:
        'Comprehensive asset management and approval system for platform administrators',
      author: {
        '@type': 'Organization',
