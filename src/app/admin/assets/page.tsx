...
export default function AdminAssetsPage() {
  ...
  const [selectedRequest, setSelectedRequest] =
    useState<AssetCreationRequest | null>(null);
  ...
  const handleSubmitReview = async () => {
    ...
    try {
      const reviewEntry = {
        ...
        requiredChanges:
          reviewStatus === 'requires_changes' ? [requiredChanges] : undefined,
      ...
      if (reviewStatus === 'approved') {
        const newAsset = {
          ...
          type:
            selectedRequest.assetType === 'commodity' ||
            selectedRequest.assetType === 'artwork' ||
            selectedRequest.assetType === 'intellectual_property'
              ? 'vault'
              : (selectedRequest.assetType as
                  | 'container'
                  | 'property'
                  | 'inventory'
                  | 'vault'),
          ...
          value:
            selectedRequest.financialDetails.valuation.valuationAmount.toString(),
          ...
          image:
            selectedRequest.basicInfo.images[0] || '/images/default-asset.jpg',
        };
      ...
      <AdminAuthGuard requiredPermissions={['manage_assets', 'approve_assets']}>
        <div className='min-h-screen bg-soft-white flex items-center justify-center'>
          <div className='text-center'>
            <Icon
              name='spinner'
              className='animate-spin text-global-teal text-4xl mb-4'
            />
        ...
        <div className='min-h-screen bg-soft-white flex items-center justify-center'>
          <div className='text-center'>
            ...
            <p className='text-gray-600 mb-4'>
              Assets data is not in the expected format.
            </p>
            <button
            ...
            <div className='max-w-7xl mx-auto px-6 lg:px-8'>
              <div className='text-center'>
                ...
                <p className='text-xl text-white/90 max-w-3xl mx-auto'>
                  Manage asset creation requests, track issuer relationships,
                  and monitor token investments across the platform.
                </p>
              </div>
            </div>
          </section>
                ...
                <div className='bg-white rounded-2xl p-6 shadow-lg'>
                  <div className='flex items-center'>
                    ...
                    <div>
                      <h3 className='text-2xl font-poppins font-bold text-charcoal'>
                        {
                          new Set((assets || []).map(a => a.name.split(' ')[0]))
                            .size
                        }
                      </h3>
                ...
                {[
                  {
                    ...
                    count: (assets || []).filter(a => a.status === 'pending')
                      .length,
                    icon: 'clock',
                  },
                  {
                    ...
                    count: (assets || []).filter(a => a.status === 'active')
                      .length,
                    icon: 'check-circle',
                  },
                  {
                      ...
                      <div>
                        ...
                        <div className='space-y-2 text-sm'>
                          ...
                          <div className='flex justify-between'>
                            ...
                            <span
                              className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(selectedAsset.status)}`}
                            >
                  ...
                  <div className='space-y-6'>
                    <div>
                      ...
                      <div className='bg-gray-50 rounded-lg p-4'>
                        <p>
                          <strong>Name:</strong>{' '}
                          {selectedRequest.basicInfo.name}
                        </p>
                        <p>
                          <strong>Type:</strong> {selectedRequest.assetType}
                        </p>
                        <p>
                          <strong>Location:</strong>{' '}
                          {selectedRequest.basicInfo.location}
                        </p>
                        <p>
                          <strong>Value:</strong>{' '}
                          {formatCurrency(
                            selectedRequest.financialDetails.valuation
                              .valuationAmount
                          )}
                        </p>
                      </div>
