...
const getEnhancedUsers = async (): Promise<User[]> => {
  ...
  const allUsers = integrationResult.success
    ? integrationResult.users || []
                ...
                <div className='flex flex-wrap gap-4'>
                  ...
                  {[
                    ...
                    },
                    {
                      key: 'issuer',
                      label: 'Issuers',
                      count: users.filter(u => u.role === 'issuer').length,
                      icon: 'building',
                    },
                    {
                      key: 'investor',
                    ...
                    },
                    {
                      key: 'verified',
                      label: 'Verified',
                      count: users.filter(u => u.status === 'verified').length,
                      icon: 'shield-check',
                    },
              ...
              <div className='space-y-6'>
                ...
                <div className='grid md:grid-cols-2 gap-6'>
                  ...
                  <div>
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(selectedUser.status)}`}
                    >
                  ...
                  <div>
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-sm font-medium ${getKycStatusColor(selectedUser.kycStatus)}`}
                    >
                ...
                <div className='space-y-6'>
                  ...
                  <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
                    <div className='flex items-start'>
                      <Icon
                        name='info-circle'
                        className='text-blue-600 text-xl mr-3 mt-1'
                      />
                      <div>
                        ...
                        <p className='text-blue-800 text-sm'>
                          The password you set will be sent to the user's email
                          address. The user can change their password anytime in
