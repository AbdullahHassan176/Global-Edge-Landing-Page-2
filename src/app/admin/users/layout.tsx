...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'User management dashboard for administrators. Manage user accounts, permissions, and access controls across the platform.',
    keywords:
      'admin user management, user administration, user accounts, access control, user permissions, admin dashboard, user oversight',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://theglobaledge.io/og-admin-users.jpg',
          width: 1200,
          height: 630,
          alt: 'Admin User Management | User Administration | The Global Edge',
        },
      ],
    },
    twitter: {
...
export default function AdminUsersLayout({
  ...
  const jsonLd = {
    ...
    mainEntity: {
      ...
      description:
        'Administrative user management system for managing user accounts, permissions, and access controls across the platform',
      author: {
        '@type': 'Organization',
