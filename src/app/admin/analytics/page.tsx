          ...
          <div className='max-w-7xl mx-auto px-6 lg:px-8'>
            ...
            <div className='text-center'>
              ...
              <p className='text-xl text-white/90 max-w-3xl mx-auto'>
                Comprehensive analytics, performance metrics, and system health
                monitoring.
              </p>
            </div>
          </div>
        ...
        <section className='py-20'>
          <div className='max-w-7xl mx-auto px-6 lg:px-8'>
                ...
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <div className='flex items-center mt-2'>
                      <Icon
                        name={getGrowthIcon(analytics.userGrowth)}
                        className={`text-sm mr-1 ${getGrowthColor(analytics.userGrowth)}`}
                      />
                      <span
                        className={`text-sm font-medium ${getGrowthColor(analytics.userGrowth)}`}
                      >
              ...
              <div className='bg-white rounded-2xl p-6 shadow-lg'>
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <p className='text-3xl font-poppins font-bold text-charcoal'>
                      {formatCurrency(analytics.totalInvestments)}
                    </p>
                    <div className='flex items-center mt-2'>
                      <Icon
                        name={getGrowthIcon(analytics.investmentGrowth)}
                        className={`text-sm mr-1 ${getGrowthColor(analytics.investmentGrowth)}`}
                      />
                      <span
                        className={`text-sm font-medium ${getGrowthColor(analytics.investmentGrowth)}`}
                      >
            ...
            <div className='grid lg:grid-cols-2 gap-8 mb-8'>
              ...
              <div className='bg-white rounded-2xl p-6 shadow-lg'>
                <h3 className='text-xl font-poppins font-semibold text-charcoal mb-6'>
                  User Registrations
                </h3>
                      ...
                      <div className='flex items-center space-x-3'>
                        <div className='w-32 bg-gray-200 rounded-full h-2'>
                          <div
                            ...
                            style={{
                              width: `${(item.count / Math.max(...analytics.userRegistrations.map(r => r.count))) * 100}%`,
                            }}
                          ></div>
                        </div>
                        <span className='text-charcoal font-semibold w-12 text-right'>
                          {item.count}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className='flex items-center space-x-4'>
                      ...
                      <div>
                        ...
                        <p className='text-sm text-gray-600'>
                          {formatCurrency(asset.investments)} total investments
                        </p>
                      </div>
                    </div>
                    <div className='flex items-center space-x-2'>
                      <Icon
                        name={getGrowthIcon(asset.growth)}
                        className={`text-sm ${getGrowthColor(asset.growth)}`}
                      />
                      <span
                        className={`font-semibold ${getGrowthColor(asset.growth)}`}
                      >
                        {asset.growth}%
                      </span>
                    </div>
