...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Comprehensive analytics dashboard for administrators. Monitor system performance, user engagement, and platform metrics.',
    keywords:
      'admin analytics, performance metrics, system monitoring, user analytics, platform statistics, admin dashboard, analytics dashboard',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://theglobaledge.io/og-admin-analytics.jpg',
          width: 1200,
          height: 630,
          alt: 'Admin Analytics | Performance Metrics | The Global Edge',
        },
      ],
    },
    twitter: {
    ...
    other: {
      'script:type:application/ld+json': JSON.stringify({
        ...
        mainEntity: {
          ...
          description:
            'Comprehensive analytics and performance metrics for platform administrators',
          author: {
            '@type': 'Organization',
