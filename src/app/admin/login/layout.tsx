...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Secure administrative login portal for Global Edge platform administrators. Access the admin dashboard with enhanced security.',
    keywords:
      'admin login, administrative access, secure login, admin portal, platform administration, secure authentication',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://theglobaledge.io/og-admin-login.jpg',
          width: 1200,
          height: 630,
          alt: 'Admin Login | Secure Administrative Access | The Global Edge',
        },
      ],
    },
    twitter: {
...
export default function AdminLoginLayout({
  ...
  const jsonLd = {
    ...
    mainEntity: {
      ...
      description:
        'Secure login portal for platform administrators with enhanced security features',
      author: {
        '@type': 'Organization',
