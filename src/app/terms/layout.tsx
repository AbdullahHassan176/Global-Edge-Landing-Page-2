...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: 'terms and conditions, Global Edge UAE, platform terms, tokenization services, user agreement, legal terms, platform governance, service terms',
    ...
    openGraph: {
      ...
      type: 'website',
      images: [{ url: 'https://theglobaledge.io/og-terms.jpg', width: 1200, height: 630, alt: 'Terms & Conditions | The Global Edge UAE' }]
    },
    twitter: {
      ...baseMeta.twitter,
      title: 'Terms & Conditions | The Global Edge UAE',
