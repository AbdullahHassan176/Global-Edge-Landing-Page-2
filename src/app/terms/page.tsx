...
export default function TermsPage() {
  ...
  return (
    <>
      ...
      <section
        id='terms-hero'
        className='bg-gradient-to-br from-global-teal via-edge-purple to-aqua-end h-[300px] relative overflow-hidden'
      >
        ...
        <div className='relative max-w-7xl mx-auto px-6 lg:px-8 h-full flex items-center'>
          <div className='max-w-6xl text-white text-left'>
            ...
            <p className='text-lg font-inter font-light opacity-90 max-w-6xl leading-relaxed'>
              These terms and conditions for The Global Edge platform outline
              the legal framework governing your use of our tokenization
              services, investment platform, and digital asset management tools.
          ...
          <div className='bg-white rounded-2xl shadow-lg p-8'>
            <div className='mb-8'>
              ...
              <p className='text-gray-700 leading-relaxed'>
                ...
                Global Edge platform and services. By accessing or using our
                platform, you agree to be bound by these Terms. Please also
                review our{' '}
                <Link
                  href='/privacy'
            ...
            <div className='space-y-12'>
              <div>
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  By accessing and using the Global Edge platform, you accept
              ...
              <div>
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  Global Edge provides a platform for tokenizing real-world
                  assets including but not limited to shipping containers, real
                  estate, trade inventory, and precious metals. Our service
                  facilitates fractional ownership of these assets through
              ...
              <div>
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  For more information about data handling, please review our{' '}
                  <Link
                    href='/privacy'
                    className='text-global-teal hover:text-edge-purple transition-colors'
                  >
              ...
              <div>
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  Investing in tokenized assets involves significant risks. You
              ...
              <div>
                ...
                <p className='text-gray-700 leading-relaxed mt-4'>
                  All fees are clearly disclosed before transactions and are
              ...
              <div>
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  The Global Edge platform, including its design, functionality,
                  and content, is protected by intellectual property laws. You
                  may not:
                </p>
                <ul className='list-disc list-inside text-gray-700 space-y-2 ml-4'>
              ...
              <div>
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  To the maximum extent permitted by law, Global Edge shall not
              ...
              <div>
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  You agree to indemnify and hold harmless Global Edge, its
              ...
              <div>
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  ...
                  discretion. Upon termination, your right to use the platform
                  ceases immediately.
                </p>
              </div>
              ...
              <div>
                ...
                <div className='bg-gray-50 rounded-lg p-6'>
                  <p className='text-gray-700'>
                    <strong>{businessConfig.companyName}</strong>
                    <br />
                    Email: {contactConfig.legal.email}
                    <br />
                    Phone: {contactConfig.legal.phone}
                    <br />
      ...
      <section id='related-links' className='py-20 bg-gray-50'>
        <div className='max-w-4xl mx-auto px-6 lg:px-8'>
          ...
          <p className='text-xl text-gray-600 mb-8 text-center'>
            Review our complete legal framework. Learn about our{' '}
            <Link
              href='/privacy'
              className='text-global-teal hover:text-edge-purple transition-colors'
            >
          ...
          <div className='grid md:grid-cols-3 gap-6'>
            ...
            >
              <div className='w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-blue-600 transition-colors'></div>
            ...
            <Link
              ...
              className='bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow text-center group'
            >
              <div className='w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-red-600 transition-colors'></div>
              <h3 className='font-poppins font-semibold text-charcoal mb-2'>
                Risk Disclosures
              </h3>
              <p className='text-sm text-gray-600'>
            ...
            <Link
              ...
              className='bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow text-center group'
            >
              <div className='w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-green-600 transition-colors'></div>
              <h3 className='font-poppins font-semibold text-charcoal mb-2'>
                Cookie Policy
              </h3>
              <p className='text-sm text-gray-600'>
