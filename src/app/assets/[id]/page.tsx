...
export default function AssetDetailsPage({
  ...
  const generateChartData = (assetData: Asset) => {
    ...
    const baseValue =
      parseFloat(assetData.value.replace(/[$,]/g, '')) || 100000;
      ...
      <div className='bg-white border-b border-gray-100'>
        <div className='max-w-7xl mx-auto px-6 lg:px-8 py-4'>
          <nav className='flex items-center space-x-2 text-sm'>
            <span className='text-gray-500 hover:text-global-teal cursor-pointer'>
              Assets
            </span>
            <Icon name='chevron-right' className='text-gray-400 text-xs' />
            <span className='text-gray-500 hover:text-global-teal cursor-pointer'>
              {asset.type.charAt(0).toUpperCase() + asset.type.slice(1)}s
            </span>
            <Icon name='chevron-right' className='text-gray-400 text-xs' />
          ...
          <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
            ...
            <div className='flex items-center space-x-4'>
              <Tooltip
                content={
                  isInWatchlist
                    ? 'Remove this asset from your watchlist'
                    : 'Add this asset to your watchlist for easy tracking'
                }
              >
                <button
                ...
                >
                  <Icon
                    name={isInWatchlist ? 'heart-solid' : 'heart'}
                    className='mr-2'
                  />
          ...
          <div className='grid grid-cols-2 lg:grid-cols-8 gap-6'>
            <Tooltip content='Target annual percentage return based on current market conditions and asset performance'>
              <div className='text-center cursor-help'>
                <div className='text-2xl font-poppins font-bold text-global-teal mb-1'>
                  {asset.apr}
                </div>
            ...
            <Tooltip content='Total duration of the investment from start to expected completion'>
              <div className='text-center cursor-help'>
                <div className='text-2xl font-poppins font-bold text-charcoal mb-1'>
                  45 days
                </div>
            ...
            <Tooltip content='Days remaining until expected completion and returns distribution'>
              <div className='text-center cursor-help'>
                <div className='text-2xl font-poppins font-bold text-orange-600 mb-1'>
                  32
                </div>
        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8 py-6'>
          <div className='mb-4'>
            <Tooltip content='Track the current stage of your investment from funding to completion'>
              <h3 className='text-lg font-poppins font-semibold text-charcoal mb-2 cursor-help'>
                Investment Progress
              </h3>
            </Tooltip>
            <Tooltip content='Visual representation of where your investment stands in the lifecycle'>
              <p className='text-sm text-gray-600 cursor-help'>
                Track the current stage of your investment
              </p>
            </Tooltip>
          </div>
          <div className='flex items-center space-x-4'>
        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8 py-6'>
          <div className='mb-4'>
            ...
            <Tooltip content='View on-chain activity, contract details, and transaction history'>
              <p className='text-sm text-gray-600 cursor-help'>
                Track blockchain activity and technical details
              </p>
            </Tooltip>
          </div>
                  ...
                  <>
                    ...
                    <div className='mb-8'>
                      ...
                      <p className='text-gray-700 leading-relaxed mb-4'>
                        {asset.description ||
                          `This ${asset.type} asset represents a valuable investment opportunity in the tokenized assets market. The asset has been professionally evaluated and meets all compliance requirements for investment.`}
                      </p>
                      <p className='text-gray-700 leading-relaxed mb-6'>
                        {asset.cargo
                          ? `The cargo consists of ${asset.cargo} valued at ${asset.value}, with confirmed purchase orders and expected delivery within 45 days, generating returns through freight fees and cargo appreciation.`
                      ...
                      <div className='bg-white rounded-2xl shadow-sm border border-gray-200 p-8 mb-6'>
                        <Tooltip content='Detailed information about the current investment status and progress'>
                          <h4 className='text-xl font-semibold text-charcoal mb-6 cursor-help'>
                            Investment Details
                          </h4>
                        </Tooltip>
                          ...
                          <div>
                            ...
                            <div className='space-y-2'>
                              ...
                              <div className='flex justify-between text-sm border-t border-gray-200 pt-2'>
                                ...
                                <span className='text-global-teal font-semibold'>
                                  $16,500
                                </span>
                              </div>
                            </div>
                        ...
                        <div className='bg-white border border-gray-200 rounded-xl p-6'>
                          ...
                          <div className='space-y-3'>
                            ...
                            <div className='flex justify-between'>
                              ...
                              <span className='text-sm font-medium text-global-teal'>
                                14.2%
                              </span>
                            </div>
                          </div>
                      ...
                      <div className='grid md:grid-cols-2 gap-4'>
                        <div className='bg-green-50 border border-green-200 rounded-xl p-4'>
                          ...
                          <p className='text-xs text-gray-600 mt-2'>
                            Protected route with minimal weather exposure
                          </p>
                        </div>
                        <div className='bg-yellow-50 border border-yellow-200 rounded-xl p-4'>
                          ...
                          <p className='text-xs text-gray-600 mt-2'>
                            Standard shipping route with established protocols
                          </p>
                        </div>
                        <div className='bg-green-50 border border-green-200 rounded-xl p-4'>
                          <div className='flex items-center justify-between mb-2'>
                          ...
                          <p className='text-xs text-gray-600 mt-2'>
                            Experienced operator with 15+ years track record
                          </p>
                        </div>
                        <div className='bg-green-50 border border-green-200 rounded-xl p-4'>
                          <div className='flex items-center justify-between mb-2'>
                          ...
                          <p className='text-xs text-gray-600 mt-2'>
                            Full cargo insurance with $125K coverage
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className='space-y-6'>
                    ...
                    <div className='space-y-4'>
                      <div className='flex items-center justify-between p-4 border border-gray-200 rounded-lg'>
                        ...
                        <button
                          onClick={() =>
                            handleDocumentDownload('Container Bill of Lading')
                          }
                      ...
                      <div className='flex items-center justify-between p-4 border border-gray-200 rounded-lg'>
                        ...
                        <button
                          onClick={() =>
                            handleDocumentDownload('Insurance Certificate')
                          }
                          className='text-global-teal hover:text-edge-purple text-sm font-medium transition-colors'
                        >
                          Download
                      ...
                      <div className='flex items-center justify-between p-4 border border-gray-200 rounded-lg'>
                        ...
                        <button
                          onClick={() =>
                            handleDocumentDownload('Cargo Manifest')
                          }
                          className='text-global-teal hover:text-edge-purple text-sm font-medium transition-colors'
                        >
                          Download
                    ...
                    <div className='space-y-6'>
                      <div className='flex items-start space-x-4'>
                        ...
                        <div className='flex-1'>
                          ...
                          <p className='text-sm text-gray-600 mt-1'>
                            Container manufactured by CIMC, certified for
                      ...
                      <div className='flex items-start space-x-4'>
                        ...
                        <div className='flex-1'>
                          ...
                          <div className='text-xs text-gray-500'>
                            Dec 3, 2024 • Port of Shanghai
                          </div>
                          <p className='text-sm text-gray-600 mt-1'>
                            Electronics loaded and sealed with tamper-proof
                            locks
                          </p>
                        </div>
                      </div>
                      <div className='flex items-start space-x-4'>
                        ...
                        <div className='flex-1'>
                          ...
                          <div className='text-xs text-gray-500'>
                            Dec 5, 2024 • Shanghai Port
                          </div>
                          <p className='text-sm text-gray-600 mt-1'>
                            Vessel departed on schedule, GPS tracking activated
                          </p>
                        </div>
                      </div>
                      <div className='flex items-start space-x-4'>
                        ...
                        <div className='flex-1'>
                          ...
                          <div className='text-xs text-gray-500'>
                            Current • Port of Hamburg
                          </div>
                          <p className='text-sm text-gray-600 mt-1'>
                            Container is currently in Hamburg, temperature and
                    ...
                    <div className='space-y-4'>
                      <div className='bg-red-50 border border-red-200 rounded-xl p-4'>
                        ...
                        <p className='text-sm text-red-700'>
                          Electronics market volatility may affect cargo value.
                          Current market conditions show stable demand.
                        </p>
                      </div>
                      <div className='bg-yellow-50 border border-yellow-200 rounded-xl p-4'>
                        ...
                        <p className='text-sm text-yellow-700'>
                          Shipping delays due to weather, port congestion, or
                          regulatory changes may impact delivery timeline.
                        </p>
                      </div>
                      <div className='bg-orange-50 border border-orange-200 rounded-xl p-4'>
                        ...
                        <p className='text-sm text-orange-700'>
                          Exchange rate fluctuations between USD and EUR may
                          affect returns for European investors.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='space-y-6'>
                    ...
                    <div className='space-y-4'>
                      <div className='border border-gray-200 rounded-lg p-4'>
                        ...
                        <p className='text-sm text-gray-600'>
                          Returns are distributed within 7 days of successful
                          delivery to the destination port.
                        </p>
                      </div>
                      <div className='border border-gray-200 rounded-lg p-4'>
                        <h4 className='font-medium text-charcoal mb-2'>
                          What happens if the cargo is damaged?
                        </h4>
                        <p className='text-sm text-gray-600'>
                          The asset is fully insured for $125,000. Any damage
                          claims are processed through the insurance provider.
                        </p>
                      </div>
                      <div className='border border-gray-200 rounded-lg p-4'>
                        <h4 className='font-medium text-charcoal mb-2'>
                          Can I sell my investment before completion?
                        </h4>
                        <p className='text-sm text-gray-600'>
                          Secondary market trading is available 30 days after
                          initial investment, subject to market conditions.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className='lg:col-span-1'>
            <div className='bg-white rounded-2xl shadow-sm border border-gray-200 p-8 sticky top-24'>
              ...
              <div className='text-center mb-8'>
                <Tooltip content='Expected annual percentage return based on current market conditions'>
                  <div className='text-4xl font-poppins font-bold text-global-teal mb-2 cursor-help'>
                    {asset.apr}
                  </div>
                </Tooltip>
                <Tooltip content='Target annual percentage return for this investment'>
                  <div className='text-sm text-gray-600 mb-6 cursor-help'>
                    Target APR
                  </div>
                </Tooltip>
                ...
                <div className='bg-gray-50 rounded-lg p-4 mb-6'>
                  <Tooltip content='Progress bar showing how much funding has been raised'>
                    <div className='w-full bg-gray-200 rounded-full h-4 mb-3 cursor-help'>
                      <div
                        className='bg-gradient-to-r from-global-teal to-aqua-start h-4 rounded-full transition-all duration-500'
                        style={{ width: '87%' }}
                      ></div>
                    </div>
                  </Tooltip>
            ...
            <div className='bg-white rounded-2xl shadow-sm border border-gray-200 p-8 mt-6'>
              <Tooltip content='Track the journey of your investment from origin to destination'>
                <h3 className='text-lg font-poppins font-semibold text-charcoal mb-6 cursor-help'>
                  Logistics Timeline
                </h3>
              </Tooltip>
              <div className='space-y-6'>
          ...
          <div className='flex items-start space-x-3'>
            ...
            <div>
              ...
              <p className='text-sm text-yellow-700 leading-relaxed'>
                The target APR of 14.2% is a projection based on current market
                conditions and is not guaranteed. Investments in tokenized
                assets carry risks including market volatility, liquidity
                constraints, and potential loss of principal. This asset is
                subject to shipping delays, weather conditions, and regulatory
                changes that may affect returns. Please review all risk factors
              ...
              <div>
                ...
                <div className='flex'>
                  ...
                  <button
                    onClick={() =>
                      copyToClipboard(
                        `${window.location.origin}/assets/${params.id}`
                      )
                    }
              ...
              <div>
                ...
                <div className='grid grid-cols-2 gap-3'>
                  <button
                    onClick={() =>
                      window.open(
                        `https://twitter.com/intent/tweet?text=Check out this tokenized asset: ${window.location.href}`,
                        '_blank'
                      )
                    }
                  ...
                  <button
                    onClick={() => {
                      ...
                      copyToClipboard(
                        `Check out this tokenized asset: ${window.location.href}`
                      );
                  ...
                  <button
                    onClick={() =>
                      window.open(
                        `https://wa.me/?text=Check out this tokenized asset: ${encodeURIComponent(window.location.href)}`,
                        '_blank'
                      )
                    }
              ...
              <div>
                ...
                <div className='grid grid-cols-1 gap-3'>
                  <button
                    onClick={() =>
                      window.open(
                        `mailto:?subject=Check out this tokenized asset&body=Hi, I thought you might be interested in this tokenized asset: ${window.location.href}`,
                        '_blank'
                      )
                    }
                ...
                <div className='flex justify-between items-center p-4 bg-green-50 rounded-lg border border-green-200'>
                  <div>
                    ...
                    <p className='text-sm text-green-600'>
                      Annual profit from your investment
                    </p>
                  </div>
                ...
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-xs text-yellow-700 mt-1'>
                      Returns are projections based on current market conditions
                      and are not guaranteed. Past performance does not indicate
                      future results.
                    </p>
                  </div>
                </div>
              ...
              <div className='flex space-x-3'>
                ...
                <button
                  onClick={() => {
                    ...
                    document
                      .querySelector('button:contains("Invest Now")')
