                  ...
                  <div className='bg-white rounded-2xl p-8 shadow-lg'>
                    <div className='flex items-center mb-6'>
                      ...
                      <div>
                        ...
                        <p className='text-global-teal font-medium'>
                          Physical & Legal Validation
                        </p>
                      </div>
                    </div>
                    <p className='text-gray-600 mb-6'>
                      Independent third-party verification of asset existence,
                      condition, ownership, and legal compliance. All
                      documentation is reviewed by certified appraisers and
                      legal experts.
                    </p>
                  ...
                  <div className='bg-gradient-to-br from-blue-100 to-blue-50 rounded-2xl p-8'>
                    <div className='grid grid-cols-2 gap-4 mb-6'>
                      <div className='bg-white rounded-lg p-4 text-center'>
                        <Icon
                          name='search'
                          className='text-blue-600 text-lg mb-2'
                          size={8}
                        />
              ...
              <div className='flex flex-col lg:flex-row-reverse items-center lg:space-x-reverse lg:space-x-16'>
                <div className='lg:w-1/2 lg:pl-8 mb-8 lg:mb-0'>
                  <div className='bg-white rounded-2xl p-8 shadow-lg'>
                    ...
                    <p className='text-gray-600 mb-6'>
                      Creation of legal framework including Special Purpose
                      Vehicle (SPV) formation, custody agreements, and investor
                      protection mechanisms with regulatory compliance
                      documentation.
                    </p>
                    <div className='space-y-3'>
                      <div className='flex items-center'>
                      ...
                      <div className='flex items-center'>
                        ...
                        />
                        <span className='text-sm text-gray-700'>
                          Custody and management agreements
                        </span>
                      </div>
                      <div className='flex items-center'>
                        <Icon
                        ...
                        />
                        <span className='text-sm text-gray-700'>
                          Investor rights and protection terms
                        </span>
                      </div>
                      <div className='flex items-center'>
                        <Icon
                  ...
                  <div className='bg-gradient-to-br from-green-100 to-green-50 rounded-2xl p-8'>
                    <div className='space-y-4 mb-6'>
                      <div className='bg-white rounded-lg p-4 flex items-center'>
                        <Icon
                          name='building'
                          className='text-green-600 text-lg mr-4'
                          size={12}
                        />
                        <div>
                  ...
                  <div className='bg-gradient-to-br from-purple-100 to-purple-50 rounded-2xl p-8'>
                    <div className='grid grid-cols-2 gap-4 mb-6'>
                      <div className='bg-white rounded-lg p-4 text-center'>
                        <Icon
                          name='location-dot'
                          className='text-purple-600 text-lg mb-2'
                          size={12}
                        />
                        <p className='text-sm font-medium text-gray-700'>
                          Location
              ...
              <div className='flex flex-col lg:flex-row-reverse items-center lg:space-x-reverse lg:space-x-16'>
                <div className='lg:w-1/2 lg:pl-8 mb-8 lg:mb-0'>
                  <div className='bg-white rounded-2xl p-8 shadow-lg'>
                    ...
                    <p className='text-gray-600 mb-6'>
                      Development and deployment of audited smart contracts that
                      govern token mechanics, ownership rights, revenue
                      distribution, and investor protections on the blockchain
                      network.
                    </p>
                    <div className='space-y-3'>
                      <div className='flex items-center'>
                  ...
                  <div className='bg-gradient-to-br from-orange-100 to-orange-50 rounded-2xl p-8'>
                    <div className='space-y-4 mb-6'>
                      <div className='bg-white rounded-lg p-4 flex items-center'>
                        <Icon
                          name='file-code'
                          className='text-orange-600 text-lg mr-4'
                          size={12}
                        />
                        <div>
                          <p className='font-medium text-gray-700'>
                    ...
                    <div className='text-center'>
                      ...
                      <div className='text-xl font-poppins font-bold text-orange-600'>
                        3-5 Business Days
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='bg-white rounded-2xl p-8 shadow-lg'>
                    ...
                    <div className='space-y-3'>
                      <div className='flex items-center'>
                        <Icon
                          name='clipboard'
                          className='text-global-teal mr-3'
                          size={12}
                        />
                        <span className='text-sm text-gray-700'>
                      ...
                      <div className='flex items-center'>
                        ...
                        />
                        <span className='text-sm text-gray-700'>
                          Investor onboarding activation
                        </span>
                      </div>
                      <div className='flex items-center'>
                        <Icon
                  ...
                  <div className='bg-gradient-to-br from-teal-100 to-teal-50 rounded-2xl p-8'>
                    <div className='grid grid-cols-2 gap-4 mb-6'>
                      <div className='bg-white rounded-lg p-4 text-center'>
                        <Icon
                          name='check-double'
                          className='text-global-teal text-lg mb-2'
                          size={12}
                        />
                        <p className='text-sm font-medium text-gray-700'>
                          Compliance
                    ...
                    <div className='text-center'>
                      ...
                      <div className='text-xl font-poppins font-bold text-global-teal'>
                        1-2 Business Days
                      </div>
                    </div>
                  </div>
              ...
              <div className='space-y-4'>
                ...
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600 text-sm'>
                      Comprehensive legal frameworks including SPV formation,
                      custody agreements, and investor protection mechanisms.
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600 text-sm'>
                      Robust investor protection measures including KYC/KYB
                      verification, risk disclosures, and transparent reporting.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
            <div className='bg-gray-50 rounded-2xl p-8 text-center hover:bg-gray-100 transition-colors'>
              ...
              <p className='text-gray-600'>
                Complete audit trail from asset verification to token deployment
                with timestamped records
              </p>
            </div>
            ...
            <div className='bg-gray-50 rounded-2xl p-8 text-center hover:bg-gray-100 transition-colors'>
              ...
              <p className='text-gray-600'>
                All critical milestones recorded immutably on blockchain for
            ...
            <div className='bg-gray-50 rounded-2xl p-8 text-center hover:bg-gray-100 transition-colors'>
              ...
              <p className='text-gray-600'>
                Automated notifications and dashboard updates throughout the
                tokenization process
              </p>
            </div>
            ...
            <div className='bg-gray-50 rounded-2xl p-8 text-center hover:bg-gray-100 transition-colors'>
              ...
              <p className='text-gray-600'>
                Secure investor portal with access to all legal documents and
                audit reports
              </p>
            </div>
      ...
      {showListAssetModal && (
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
          <div className='bg-white rounded-2xl p-8 max-w-md w-full mx-4'>
            ...
            <div className='space-y-4'>
              <p className='text-gray-600'>
                Ready to tokenize your real-world asset? Get started with our
      ...
      {showLearnMoreModal && (
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
          <div className='bg-white rounded-2xl p-8 max-w-md w-full mx-4'>
            ...
            <div className='space-y-4'>
              <p className='text-gray-600'>
                Discover more about our tokenization platform and investment
                opportunities.
              </p>
              <div className='space-y-3'>
                <a
                  href='/assets'
                  className='flex items-center text-global-teal hover:text-edge-purple'
                >
