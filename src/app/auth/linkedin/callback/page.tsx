...
function LinkedInCallbackPageContent() {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      try {
        ...
        const userData = await oauthService.handleLinkedInCallback(code);
        setUser(userData);
        setStatus('success');
        ...
        <div className='text-center'>
          {status === 'loading' && (
            <>
              <div className='w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4'>
                <Icon
                  name='clock'
                  className='animate-spin text-blue-600 text-2xl'
                />
              </div>
              ...
              <p className='text-gray-600'>
                Please wait while we verify your LinkedIn account...
              </p>
            </>
          )}
          ...
          {status === 'error' && (
            <>
              ...
              <p className='text-gray-600 mb-4'>
                There was an error authenticating with LinkedIn. Please try
                again.
              </p>
              <button
