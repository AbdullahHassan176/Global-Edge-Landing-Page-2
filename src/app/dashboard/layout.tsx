...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Access your investor dashboard — monitor tokenized assets, portfolio performance, and compliance documentation on The Global Edge platform.',
    keywords: 'investor dashboard, asset management, portfolio tracking, tokenized assets, investment portal, compliance documentation, RWA dashboard',
    ...
    openGraph: {
      ...
      type: 'website',
      images: [{ url: 'https://theglobaledge.io/og-dashboard.jpg', width: 1200, height: 630, alt: 'Dashboard | Asset Management & Investor Portal | The Global Edge' }]
    },
    twitter: {
      ...baseMeta.twitter,
      title: 'Dashboard | Asset Management & Investor Portal | The Global Edge',
