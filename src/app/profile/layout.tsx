...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Manage your personal information, investment preferences, and account settings on The Global Edge platform.',
    keywords:
      'user profile, account management, personal information, investment preferences, account settings, user dashboard',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://theglobaledge.io/og-profile.jpg',
          width: 1200,
          height: 630,
          alt: 'My Profile | Account Management | The Global Edge',
        },
      ],
    },
    twitter: {
...
export default function ProfileLayout({
  ...
  const jsonLd = {
    ...
    mainEntity: {
      ...
      description:
        'Personal account management and investment profile settings',
      author: {
        '@type': 'Person',
