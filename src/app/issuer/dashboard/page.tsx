      ...
      <div className='flex items-center'>
        ...
        <div>
          ...
          <p className='text-sm text-gray-600'>
            ${investment.amount.toLocaleString()} • {investment.tokens} tokens
          </p>
        </div>
      </div>
...
export default function IssuerDashboard() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const pendingKyc = allInvestments.filter(
        inv => inv.status === 'pending' && inv.kycRequired && !inv.kycCompleted
      ).length;

      const totalValue = issuerAssets.reduce(
        (sum, asset) =>
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-gray-600 mt-1'>
                  Manage your tokenized asset listings and performance reports.
                </p>
              </div>
              <div className='flex items-center space-x-4'>
              ...
              <div className='bg-white rounded-xl shadow-sm p-6 border border-gray-200 cursor-help'>
                <div className='flex items-center'>
                  ...
                  <div className='ml-4'>
                    ...
                    <p className='text-2xl font-bold text-gray-900'>
                      ${stats.assetsUnderManagement.toLocaleString()}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className='p-6'>
              {investments.length === 0 ? (
                <div className='text-center py-12'>
                  ...
                  <p className='text-gray-600'>
                    Start by creating your first asset to attract investors.
                  </p>
                </div>
              ) : (
