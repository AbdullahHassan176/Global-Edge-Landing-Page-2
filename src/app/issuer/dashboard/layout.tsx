...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Manage your tokenized assets, track performance, and oversee your investment platform on The Global Edge.',
...
export default function IssuerDashboardLayout({ children }: { children: React.ReactNode }) {
  return children;
}
