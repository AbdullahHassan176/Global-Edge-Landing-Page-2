...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Customize your branding and appearance on The Global Edge platform. Manage your issuer profile and visual identity.',
...
export default function IssuerBrandingLayout({
  children,
}: {
