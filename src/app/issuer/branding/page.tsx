      ...
      <div className='min-h-screen bg-gray-50 flex items-center justify-center'>
        <div className='text-center'>
          <p className='text-gray-600'>
            Please log in to access branding settings.
          </p>
        </div>
      </div>
    );
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-gray-600 mt-1'>
                  Customize your brand presence within The Global Edge
                  ecosystem.
                </p>
              </div>
                ...
                <div className='p-6 space-y-6'>
                  ...
                  <div>
                    ...
                    <p className='text-xs text-gray-500 mt-1'>
                      Optional: Custom domain for your investor portal
                    </p>
                  </div>
...
.custom-button {
  ...
  border-radius: 8px;
                    ...
                    />
                    <p className='text-xs text-gray-500 mt-1'>
                      Add custom CSS to further customize your portal's
                      appearance
                    </p>
                  </div>
                </div>
                  ...
                  {previewMode ? (
                    <div className='space-y-6'>
                      ...
                      <div className='bg-white border border-gray-200 rounded-lg p-6'>
                        ...
                        >
                          Welcome to {branding.companyName || 'Your Company'}{' '}
                          Investor Portal
                        </h3>
                        <p className='text-gray-600 mb-4'>
                          This is how your investor portal will look with your
                          branding applied.
                        </p>
                      ...
                      <div className='bg-gray-50 border border-gray-200 rounded-lg p-4'>
                        <div className='text-center text-sm text-gray-600'>
                          <p>
                            © 2025 {branding.companyName || 'Your Company'}.
                            All rights reserved.
                          </p>
                          {branding.footerText && (
                    ...
                    <div className='text-center py-12'>
                      ...
                      <p className='text-gray-600 mb-6'>
                        Click the "Preview" button to see how your investor
                        portal will look with your custom branding.
                      </p>
                      <button
              ...
              <div className='bg-white rounded-xl shadow-sm border border-gray-200'>
                ...
                <div className='p-6'>
                  ...
                  <p className='text-xs text-gray-500 mt-2'>
                    This CSS will be automatically applied to your investor
                    portal.
                  </p>
                </div>
              </div>
