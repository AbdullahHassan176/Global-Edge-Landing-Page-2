...
import {
  userAuthService as investorService,
  User,
  Investment,
  Notification,
...
export default function InvestorManagementPage() {
  ...
  const loadData = async () => {
    try {
      ...
      const allInvestments = await investorService.getInvestments(
        currentUser.id
      );
      ...
      <div className='min-h-screen bg-gray-50 flex items-center justify-center'>
        <div className='text-center'>
          <p className='text-gray-600'>
            Please log in to access investor management.
          </p>
        </div>
      </div>
    );
            ...
            <div className='flex items-center justify-between'>
              <div>
                <h1 className='text-3xl font-bold text-gray-900'>
                  Manage Issuer Investors
                </h1>
                <p className='text-gray-600 mt-1'>
                  Monitor and engage your investor base across tokenized
                  projects.
                </p>
              </div>
              ...
              <div className='flex items-center'>
                ...
                <div className='ml-4'>
                  ...
                  <p className='text-2xl font-bold text-gray-900'>
                    {
                      investors.filter(
                        inv => inv.kycStatus === 'pending_review'
                      ).length
                    }
                  </p>
                </div>
                ...
                <tbody className='bg-white divide-y divide-gray-200'>
                  {filteredInvestors.map(investor => (
                    <tr key={investor.id} className='hover:bg-gray-50'>
                      ...
                      <td className='px-6 py-4 whitespace-nowrap'>
                        <span
                          className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(investor.status)}`}
                        >
                      ...
                      <td className='px-6 py-4 whitespace-nowrap'>
                        <span
                          className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getKYCStatusColor(investor.kycStatus)}`}
                        >
                        ...
                        <div className='flex space-x-2'>
                          ...
                          {investor.kycStatus === 'pending_review' && (
                            <div className='flex space-x-1'>
                              <button
                                onClick={() =>
                                  handleUpdateKYCStatus(investor.id, 'approved')
                                }
                              ...
                              <button
                                onClick={() =>
                                  handleUpdateKYCStatus(investor.id, 'rejected')
                                }
                ...
                <div className='bg-gray-50 rounded-lg p-4'>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <div>
                      ...
                      <p className='font-medium'>
                        {selectedInvestor.country || 'Not provided'}
                      </p>
                    </div>
                    <div>
                      <p className='text-sm text-gray-600'>Status</p>
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(selectedInvestor.status)}`}
                      >
                    ...
                    <div>
                      ...
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getKYCStatusColor(selectedInvestor.kycStatus)}`}
                      >
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <div>
                      ...
                      <p className='font-medium'>
                        $
                        {(
                          selectedInvestor.investmentLimit || 0
                        ).toLocaleString()}
                      </p>
                    </div>
                    <div>
                ...
                {selectedInvestor.kycStatus === 'pending_review' && (
                  <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4'>
                    ...
                    <p className='text-yellow-800 mb-4'>
                      This investor's KYC documents are pending review. Please
                      review the documents and approve or reject their
                      verification.
                    </p>
