...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Manage your investors, track engagement, and oversee investment activities on The Global Edge platform.',
...
export default function IssuerInvestorsLayout({ children }: { children: React.ReactNode }) {
  return children;
}
