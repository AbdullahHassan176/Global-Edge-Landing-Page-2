...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Manage your tokenized assets, create new assets, and oversee your investment portfolio on The Global Edge platform.',
...
export default function IssuerAssetsLayout({
  children,
}: {
