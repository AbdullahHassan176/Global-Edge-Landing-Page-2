            ...
            <div className='flex items-center justify-between'>
              <div>
                <h1 className='text-3xl font-bold text-gray-900'>
                  Issuer Assets Management
                </h1>
                <p className='text-gray-600 mt-1'>
                  View and update your issued tokenized assets.
                </p>
              </div>
              <button
                  ...
                  <p className='text-2xl font-bold text-gray-900'>
                    ...
                    {assets
                      .reduce(
                        (sum, asset) =>
                          sum +
                          parseInt(asset.value.replace(/[^0-9]/g, '') || '0'),
                        0
                      )
                      .toLocaleString()}
                  </p>
              ...
              {assets.length === 0 ? (
                <div className='text-center py-12'>
                  ...
                  <p className='text-gray-600 mb-6'>
                    Create your first tokenized asset to start attracting
                    investors.
                  </p>
                  <button
                    onClick={() => setShowAddModal(true)}
                    ...
                    >
                      ...
                      {!loadingHealth[asset.id] && assetHealth[asset.id] && (
                        <div className='flex items-center space-x-2 mb-4'>
                          ...
                          >
                            <Icon
                              name={getOracleStatusIcon(
                                assetHealth[asset.id].oracle.status
                              )}
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  <div>
                    ...
                    <input
                      ...
                      value={formData.apr}
                      onChange={e =>
                        setFormData(prev => ({ ...prev, apr: e.target.value }))
                      }
                      className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-global-teal focus:border-transparent'
                      required
                    />
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={e =>
                        setFormData(prev => ({
                          ...prev,
                          risk: e.target.value as Asset['risk'],
                        }))
                      }
                      className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-global-teal focus:border-transparent'
                    >
