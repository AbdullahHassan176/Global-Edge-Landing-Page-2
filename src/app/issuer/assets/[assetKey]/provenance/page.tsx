      ...
      const mockTimeline: TimelineItem[] = [
        {
          ...
          event: {
            txHash:
              '0xabc123def456abc123def456abc123def456abc123def456abc123def456',
        ...
        },
        {
          ...
          event: {
            txHash:
              '0xdef456abc123def456abc123def456abc123def456abc123def456abc',
          ...
          {timeline.length === 0 ? (
            <div className='text-center py-8'>
              ...
              <p className='mt-2 text-sm text-gray-500'>
                No events or documents found for this asset.
              </p>
            </div>
          ) : (
                ...
                <li key={index} className='relative flex gap-x-4'>
                  ...
                  <div className='relative flex h-6 w-6 flex-none items-center justify-center bg-white'>
                    {item.type === 'event' ? (
                      ...
                      <Icon
                        name='document-text'
                        className='h-6 w-6 text-edge-purple'
                      />
                    )}
                  </div>
                    ...
                    <p className='text-sm leading-6 text-gray-700'>
                      {item.type === 'event' ? (
                        <>
                          Tx Hash:{' '}
                          <a
                            href={`https://explorer.example.com/tx/${item.event?.txHash}`}
                            target='_blank'
                            rel='noopener noreferrer'
                            className='text-global-teal hover:underline'
                          >
