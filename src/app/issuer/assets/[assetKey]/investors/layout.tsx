...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  const baseMeta = await generateDynamicMetadata({ path: `/issuer/assets/${params.assetKey}/investors` });
...
export default function IssuerAssetInvestorsLayout({ children }: { children: React.ReactNode }) {
  return children;
}
