      ...
      <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-8'>
        <div className='text-center'>
          ...
          <h3 className='mt-4 text-lg font-medium text-gray-900'>
            Financing Feature Coming Soon
          </h3>
          <p className='mt-2 text-sm text-gray-500'>
            The investor management feature is currently under development and
    ...
    return (
      <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-8'>
        <div className='flex items-center justify-center'>
          <Icon
            name='spinner'
            className='animate-spin h-8 w-8 text-global-teal'
          />
            ...
            <tbody className='bg-white divide-y divide-gray-200'>
              {investors.map(investor => (
                <tr key={investor.id}>
                  ...
                  <td className='px-6 py-4 whitespace-nowrap'>
                    <span
                      className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(investor.status)}`}
                    >
                      {investor.status}
                    </span>
                  </td>
                  <td className='px-6 py-4 whitespace-nowrap'>
                    <span
                      className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getKycStatusColor(investor.kycStatus)}`}
                    >
                      {investor.kycStatus}
                    </span>
                  </td>
