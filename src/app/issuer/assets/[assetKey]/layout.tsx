...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  const baseMeta = await generateDynamicMetadata({ path: `/issuer/assets/${params.assetKey}` });
...
export default function IssuerAssetDetailLayout({ children }: { children: React.ReactNode }) {
  return children;
}