...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  const baseMeta = await generateDynamicMetadata({ path: `/issuer/assets/${params.assetKey}/admin` });
...
export default function IssuerAssetAdminLayout({ children }: { children: React.ReactNode }) {
  return children;
}
