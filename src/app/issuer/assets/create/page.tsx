...
} from '@/lib/assetCreationService';
import {
  assetValidationService,
  ValidationResult,
} from '@/lib/assetValidationService';

export default function CreateAssetPage() {
  const router = useRouter();
  const [user, setUser] = useState<any>(null);
  const [currentStep, setCurrentStep] =
    useState<AssetCreationStep>('basic_info');
  ...
  const steps: {
  ...
  }[] = [
    {
      ...
      description: 'Asset details and location',
    },
    {
      key: 'tokenization_details',
      title: 'Tokenization',
      description: 'Token structure and economics',
    },
    {
    ...
    },
    {
      ...
      description: 'Valuation and projections',
    },
    {
      key: 'technical_specs',
    ...
    },
    {
      ...
      description: 'Investor verification',
    },
    {
      key: 'investor_criteria',
      title: 'Investor Criteria',
      description: 'Investment restrictions',
    },
    {
  ...
  const loadData = async () => {
    try {
      ...
      const newRequest = await assetCreationService.createAssetRequest(
        currentUser.id
      );
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      const updatedRequest = await assetCreationService.updateAssetRequest(
        request.id,
        request
      );
      if (updatedRequest) {
  ...
  const validateCurrentStep = () => {
    ...
    const validation = assetValidationService.validateStep(
      request,
      currentStep
    );
  ...
  const getRequiredDocuments = () => {
    if (!request) return [];
    return assetCreationService.getRequiredDocuments(
      request.assetType,
    ...
    <div className='min-h-screen bg-gray-50'>
      ...
      {currentValidation && (
        <ErrorExplanationModal
          ...
          stepName={
            steps.find(s => s.key === currentStep)?.title || 'Current Step'
          }
        />
      )}
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-gray-600 mt-1'>
                Tokenize your asset for investment opportunities
              </p>
            </div>
            ...
            <div className='bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-8'>
              ...
              <div className='space-y-2'>
                {steps.map((step, index) => {
                  ...
                  const hasWarnings =
                    stepValidation && stepValidation.warnings.length > 0;
    ...
    <div className='space-y-6'>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        ...
        <div>
          ...
          <select
            ...
            onChange={e =>
              setRequest({ ...request, assetType: e.target.value })
            }
            className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-global-teal focus:border-transparent'
          >
      ...
      <div>
        ...
        <p className='text-sm text-gray-600 mb-4'>
          Upload high-quality images that showcase your asset. At least one
          image is required.
        </p>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        <div>
          ...
          <select
            ...
            onChange={e =>
              setRequest({ ...request, tokenStandard: e.target.value })
            }
            className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-global-teal focus:border-transparent'
          >
          ...
          <input
            ...
            onChange={e =>
              setRequest({
                ...
                tokenizationDetails: {
                  ...request.tokenizationDetails,
                  minimumInvestment: parseFloat(e.target.value) || 0,
                },
              })
            }
            className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-global-teal focus:border-transparent'
          ...
          <input
            ...
            onChange={e =>
              setRequest({
                ...
                legalCompliance: {
                  ...request.legalCompliance,
                  regulatoryFramework: e.target.value,
                },
              })
            }
            className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-global-teal focus:border-transparent'
            ...
            onChange={e =>
              setRequest({
                ...
                financialDetails: {
                  ...
                  valuation: {
                    ...request.financialDetails.valuation,
                    valuationAmount: parseFloat(e.target.value) || 0,
                  },
                },
              })
            }
            ...
            onChange={e =>
              setRequest({
                ...
                financialDetails: {
                  ...request.financialDetails,
                  revenueModel: {
                    ...request.financialDetails.revenueModel,
          ...
          <input
            ...
            onChange={e =>
              setRequest({
                ...
                technicalSpecs: {
                  ...request.technicalSpecs,
                  contractVersion: e.target.value,
                },
              })
            }
            className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-global-teal focus:border-transparent'
              ...
              onChange={e =>
                setRequest({
                  ...
                  technicalSpecs: {
                    ...request.technicalSpecs,
                    securityAudit: {
                      ...request.technicalSpecs.securityAudit,
    ...
    <div className='space-y-6'>
      <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
        ...
        <p className='text-blue-800 text-sm mb-4'>
          The following documents are required for {request.assetType} assets
          using {request.tokenStandard} standard:
        </p>
  ...
  return (
    <div className='space-y-6'>
          ...
          <input
            ...
            onChange={e =>
              setRequest({
                ...request,
                investorCriteria: {
                  ...request.investorCriteria,
                  minimumNetWorth: parseFloat(e.target.value) || undefined,
                },
              })
            }
            className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-global-teal focus:border-transparent'
          ...
          <input
            ...
            onChange={e =>
              setRequest({
                ...
                investorCriteria: {
                  ...request.investorCriteria,
                  minimumIncome: parseFloat(e.target.value) || undefined,
                },
              })
            }
            className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-global-teal focus:border-transparent'
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        <div>
          <label className='block text-sm font-medium text-gray-700 mb-2'>
            Minimum Investment Experience (Years)
          </label>
          <input
            type='number'
          ...
          <input
            ...
            onChange={e =>
              setRequest({
                ...
                investorCriteria: {
                  ...request.investorCriteria,
                  maximumInvestors: parseInt(e.target.value) || undefined,
                },
              })
            }
            className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-global-teal focus:border-transparent'
    ...
    <div className='space-y-6'>
      <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4'>
        ...
        <div className='space-y-2'>
          <div className='flex items-center'>
            <Icon
              name={request.basicInfo.name ? 'check-circle' : 'x-circle'}
              className={`mr-2 ${request.basicInfo.name ? 'text-green-600' : 'text-red-600'}`}
            />
          ...
          <div className='flex items-center'>
            <Icon
              name={
                request.tokenizationDetails.totalTokens > 0
                  ? 'check-circle'
                  : 'x-circle'
              }
              className={`mr-2 ${request.tokenizationDetails.totalTokens > 0 ? 'text-green-600' : 'text-red-600'}`}
            />
          ...
          <div className='flex items-center'>
            <Icon
              name={
                request.legalCompliance.jurisdiction
                  ? 'check-circle'
                  : 'x-circle'
              }
              className={`mr-2 ${request.legalCompliance.jurisdiction ? 'text-green-600' : 'text-red-600'}`}
            />
            <span className='text-sm'>
              Legal compliance information completed
            </span>
          </div>
          <div className='flex items-center'>
            <Icon
              name={
                request.financialDetails.valuation.valuationAmount > 0
                  ? 'check-circle'
                  : 'x-circle'
              }
              className={`mr-2 ${request.financialDetails.valuation.valuationAmount > 0 ? 'text-green-600' : 'text-red-600'}`}
            />
          ...
          <div className='flex items-center'>
            <Icon
              name={
                request.technicalSpecs.blockchain ? 'check-circle' : 'x-circle'
              }
              className={`mr-2 ${request.technicalSpecs.blockchain ? 'text-green-600' : 'text-red-600'}`}
            />
      ...
      <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
        ...
        <p className='text-blue-800 text-sm mb-4'>
          Once submitted, your asset will go through a comprehensive review
          process:
        </p>
