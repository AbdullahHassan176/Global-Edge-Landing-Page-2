...
/*
SEO Link Cleanup:
- Replaced 2 self-referencing links with <span>
...
const mockInsights: Insight[] = [
  {
    ...
    description:
      'Supply chain disruptions drive increased demand for container investments as shipping rates reach record highs.',
    image:
      'https://storage.googleapis.com/uxpilot-auth.appspot.com/8e8f5f1206-41f8ac9516fc7c159218.png',
    date: 'Dec 15, 2024',
    readTime: '5 min read',
  },
  {
    ...
    description:
      'How blockchain technology is transforming property investment accessibility and liquidity.',
    image:
      'https://storage.googleapis.com/uxpilot-auth.appspot.com/b3863df69d-7dea45524a67663901de.png',
    date: 'Dec 12, 2024',
    readTime: '7 min read',
  },
  {
    ...
    description:
      'Strategic allocation to gold and silver tokens provides inflation hedge for modern portfolios.',
    image:
      'https://storage.googleapis.com/uxpilot-auth.appspot.com/ccb48f0bea-8f317986dc05f173e4bb.png',
    date: 'Dec 10, 2024',
    readTime: '6 min read',
  },
  {
    ...
    description:
      'Exploring how tokenized commodities are revolutionizing traditional trade finance and supply chain management.',
    image:
      'https://storage.googleapis.com/uxpilot-auth.appspot.com/fa903baf48-9bfa2e4ace2cf760b7cf.png',
    date: 'Dec 8, 2024',
    readTime: '8 min read',
  },
  {
    ...
    description:
      'Market analysis shows continued growth in real-world asset tokenization with increasing institutional adoption.',
    image:
      'https://storage.googleapis.com/uxpilot-auth.appspot.com/ccb48f0bea-8f317986dc05f173e4bb.png',
    date: 'Dec 5, 2024',
    readTime: '4 min read',
  },
  {
    ...
    description:
      'How decentralized oracle networks provide real-time verification and transparency for tokenized assets.',
    image:
      'https://storage.googleapis.com/uxpilot-auth.appspot.com/a632cbc427-37f3e960ba5a5967444b.png',
    date: 'Dec 3, 2024',
    readTime: '6 min read',
  },
];
...
%%EOF`;
  ...
  const handleSubscribe = () => {
    ...
    alert(
      `Thank you for subscribing! You'll receive our latest insights at ${email}`
    );
    setEmail('');
  };
      ...
      <section className='gradient-bg py-16'>
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-white max-w-6xl text-left text-balance'>
            <h1 className='text-4xl lg:text-5xl font-poppins font-bold mb-4 break-words'>
              Insights & Research
            </h1>
            ...
            <p className='text-base sm:text-lg md:text-xl opacity-90 mb-6 max-w-6xl leading-relaxed'>
              Stay informed with the latest trends, analysis, and opportunities
              in{' '}
              <Link
                href='/assets'
            ...
            <p className='text-base sm:text-lg md:text-xl opacity-90 mb-8 max-w-6xl leading-relaxed'>
              Our RWA tokenization news in the UAE covers the latest
              developments in blockchain technology, regulatory updates, and
              market trends shaping the future of real-world asset digitization.
              Stay ahead with comprehensive analysis and expert insights on{' '}
              <Link
                href='/how-it-works'
                className='underline hover:text-global-teal transition-colors'
              >
        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center mb-12'>
            <h2 className='text-4xl font-poppins font-bold text-charcoal mb-4'>
              Blockchain Insights & Compliance Updates
            </h2>
          </div>
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {filteredInsights.map(insight => (
              ...
              >
                ...
                <div className='p-6'>
                  <div
                    className={`text-sm font-medium px-2 py-1 rounded-full inline-block mb-3 ${getCategoryColor(insight.category)}`}
                  >
                    {insight.category}
                  </div>
      ...
      <section className='py-20 bg-gray-50'>
        <div className='max-w-4xl mx-auto px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl text-gray-600 mb-8'>
            Get the latest{' '}
            <span className='text-global-teal cursor-default opacity-95'>
              insights and market analysis
            </span>{' '}
            delivered to your inbox. Learn about our{' '}
            <Link
              href='/how-it-works'
        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              ...
              from our research team. Learn about our{' '}
              <Link
                href='/how-it-works'
                className='text-global-teal hover:text-edge-purple transition-colors'
              >
          ...
          <div className='grid md:grid-cols-2 gap-8'>
            <div className='bg-gradient-to-br from-global-teal to-edge-purple rounded-2xl p-8 text-white'>
              ...
              <h3 className='text-2xl font-poppins font-bold mb-4'>
                2024 Tokenization Market Report
              </h3>
              <p className='text-white opacity-90 mb-6'>
                Comprehensive analysis of the tokenization market, including
                growth trends, key players, and future opportunities.
              </p>
              <button
            ...
            <div className='bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl p-8 text-white'>
              ...
              <h3 className='text-2xl font-poppins font-bold mb-4'>
                Investor's Guide to RWA Tokenization
              </h3>
              <p className='text-white opacity-90 mb-6'>
                Everything you need to know about investing in tokenized
                real-world assets, from risk assessment to portfolio allocation.
              </p>
              <button
