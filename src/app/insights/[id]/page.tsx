    ...
    return (
      <div className='min-h-screen bg-soft-white flex items-center justify-center'>
        <div className='text-center'>
          <Icon
            name='clock'
            className='animate-spin text-global-teal text-4xl mx-auto mb-4'
          />
    ...
    <div className='min-h-screen bg-soft-white'>
      ...
      <section className='bg-gradient-to-br from-global-teal to-edge-purple text-white py-20'>
        <div className='max-w-4xl mx-auto px-6 lg:px-8'>
          ...
          <div
            className={`text-sm font-medium px-3 py-1 rounded-full inline-block mb-4 ${getCategoryColor(insight.category)}`}
          >
            {insight.category}
          </div>
            ...
            <div className='p-8 md:p-16'>
              ...
              <div className='flex items-center justify-between mb-8 pb-6 border-b border-gray-100'>
                <div className='flex items-center space-x-4'>
                  <div
                    className={`text-sm font-semibold px-4 py-2 rounded-full ${getCategoryColor(insight.category)}`}
                  >
                    {insight.category}
                  </div>
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: insight.content
                        .replace(
                          /<h2>/g,
                          '<h2 class="text-3xl font-poppins font-bold text-charcoal mb-6 mt-12 first:mt-0">'
                        )
                        .replace(
                          /<h3>/g,
                          '<h3 class="text-2xl font-poppins font-semibold text-charcoal mb-4 mt-8">'
                        )
                        .replace(
                          /<p>/g,
                        ...
                        .replace(
                          /<li>/g,
                          '<li class="text-lg text-gray-700 leading-relaxed flex items-start"><span class="w-2 h-2 bg-global-teal rounded-full mt-3 mr-3 flex-shrink-0"></span>'
                        )
                        .replace(
                          /<strong>/g,
      ...
      <section className='py-20 bg-gray-50'>
        <div className='max-w-4xl mx-auto px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl text-gray-600 mb-8'>
            Put your knowledge into action with Global Edge&apos;s tokenized
            assets
          </p>
