...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Discover our ecosystem partners — logistics operators, asset managers, and technology providers enabling secure tokenization infrastructure in the UAE.',
    keywords: 'partners UAE, institutional alliances, logistics partners, asset managers, technology providers, tokenization infrastructure, blockchain partners, RWA partners',
    ...
    openGraph: {
      ...
      type: 'website',
      images: [{ url: 'https://theglobaledge.io/og-partners.jpg', width: 1200, height: 630, alt: 'Our Partners | Institutional Alliances | The Global Edge' }]
    },
    twitter: {
      ...baseMeta.twitter,
      title: 'Our Partners | Institutional Alliances | The Global Edge',
