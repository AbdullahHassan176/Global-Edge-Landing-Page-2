...
export default function CookiesPage() {
  ...
  return (
    <>
      ...
      <section
        id='cookies-hero'
        className='bg-gradient-to-br from-global-teal via-edge-purple to-aqua-end h-[350px] relative overflow-hidden'
      >
        ...
        <div className='relative max-w-7xl mx-auto px-6 py-6 lg:px-8 h-full flex items-center'>
          <div className='max-w-4xl lg:max-w-5xl text-white text-balance'>
            ...
            <p className='text-base sm:text-lg md:text-xl font-inter font-light opacity-90 max-w-3xl leading-relaxed'>
              Our cookies policy and analytics in the UAE comply with
              international data protection standards while providing enhanced
              user experience through performance monitoring and preference
              management. We implement transparent cookie practices that respect
              user privacy and{' '}
              <Link
                href='/privacy'
                className='underline hover:text-global-teal transition-colors'
          ...
          <div className='bg-white rounded-2xl shadow-lg p-8'>
            <div className='mb-8'>
              ...
              <p className='text-gray-700 leading-relaxed'>
                This Cookie Policy explains how Global Edge uses cookies and
                similar technologies when you visit our website and use our
                platform. Please also review our{' '}
                <Link
                  href='/privacy'
            ...
            <div className='space-y-12'>
              <div>
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  ...
                  and other settings, making your next visit easier and the site
                  more useful to you.
                </p>
                <p className='text-gray-700 leading-relaxed'>
              ...
              <div>
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  We use cookies for several purposes to improve your experience
                  on our platform:
                </p>
              ...
              <div>
                ...
                <ul className='list-disc list-inside text-gray-700 space-y-2 ml-4'>
                  ...
                  <li>
                    <strong>Intercom:</strong> Customer support and chat
                    functionality
                  </li>
                  <li>
                    <strong>Hotjar:</strong> User experience and behavior
                    analysis
                  </li>
                  <li>
              ...
              <div>
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  You have several options for managing cookies. Learn more
                  about our{' '}
                  <Link
                    href='/privacy'
                    className='text-global-teal hover:text-edge-purple transition-colors'
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  ...
                  consent manager, which allows you to:
                </p>
                <ul className='list-disc list-inside text-gray-700 space-y-2 ml-4'>
      ...
      <section id='cookie-management' className='py-20 bg-gray-50'>
        <div className='max-w-4xl mx-auto px-6 lg:px-8'>
          ...
          <p className='text-xl text-gray-600 mb-8 text-center'>
            Control your cookie settings and preferences. Learn more about our{' '}
            <Link
              href='/privacy'
              className='text-global-teal hover:text-edge-purple transition-colors'
            >
          ...
          <div className='bg-white rounded-2xl p-8 shadow-lg'>
            <div className='space-y-6'>
              <div className='flex items-center justify-between p-4 bg-gray-50 rounded-lg'>
                <div>
                  <h3 className='font-poppins font-semibold text-charcoal'>
                    Essential Cookies
                  </h3>
