...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Details on how The Global Edge uses cookies and analytics to enhance site performance and user experience.',
    keywords:
      'cookies policy, analytics, performance, site performance, user experience, cookie management, browser preferences, tracking cookies, analytics cookies',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://theglobaledge.io/og-cookies.jpg',
          width: 1200,
          height: 630,
          alt: 'Cookies Policy | Analytics & Performance | The Global Edge',
        },
      ],
    },
    twitter: {
...
export default function CookiesLayout({
  ...
  const jsonLd = {
    ...
    mainEntity: {
      ...
      description:
        'Managing your browser preferences for cookies and analytics',
      author: {
        '@type': 'Organization',
