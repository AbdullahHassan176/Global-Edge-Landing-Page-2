      ...
      <div className='relative z-10 max-w-6xl w-full mx-4'>
        <div className='text-center mb-12'>
          ...
          <p className='text-white/80 text-xl max-w-2xl mx-auto leading-relaxed'>
            Select whether you want to issue investment opportunities or invest
            in tokenized assets
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-2 gap-8 max-w-4xl mx-auto'>
          ...
          >
            <div className='bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 h-full'>
              ...
              <p className='text-white/80 text-lg mb-8 text-center leading-relaxed'>
                Tokenize your real-world assets and offer investment
          ...
          >
            <div className='bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 h-full'>
              ...
              {/* Description */}
              <p className='text-white/80 text-lg mb-8 text-center leading-relaxed'>
                Invest in tokenized real-world assets with transparent returns
                and full compliance
              </p>
