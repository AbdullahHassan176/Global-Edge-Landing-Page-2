...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Choose your role on The Global Edge platform - become an investor or issuer to start your tokenized asset journey.',
...
export default function RegisterRoleLayout({ children }: { children: React.ReactNode }) {
  return children;
}
