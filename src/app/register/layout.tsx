...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: 'register, create account, Global Edge, tokenized asset investments, real-time dashboards, blockchain documentation, account creation, user registration',
    ...
    openGraph: {
      ...
      type: 'website',
      images: [{ url: 'https://theglobaledge.io/og-register.jpg', width: 1200, height: 630, alt: 'Register | Create Your Account | The Global Edge' }]
    },
    twitter: {
      ...baseMeta.twitter,
      title: 'Register | Create Your Account | The Global Edge',
