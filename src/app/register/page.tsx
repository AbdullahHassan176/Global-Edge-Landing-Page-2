        ...
        <div className='relative z-10 max-w-md w-full mx-4'>
          <div className='bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 text-center'>
            ...
            <p className='text-white/80 text-lg mb-8 leading-relaxed'>
              Welcome to Global Edge! Your account has been created and is now
              pending admin approval. You'll receive an email notification once
            ...
            <div className='bg-blue-500/10 border border-blue-500/20 rounded-2xl p-6 mb-8'>
              ...
              <div className='text-white/80 text-sm space-y-2'>
                <p>
                  If your account is not approved within 48 hours, contact our
                  support team:
                </p>
                <div className='mt-3 space-y-1'>
                  ...
                  <p>
                    <strong>Hours:</strong> 9 AM - 6 PM (UAE Time)
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className='bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8'>
            ...
            <div className='text-center mb-8 max-w-3xl mx-auto text-balance'>
              <div className='w-16 h-16 bg-gradient-to-br from-global-teal to-edge-purple rounded-full flex items-center justify-center mx-auto mb-4'>
                <Icon
                  name={selectedRole === 'issuer' ? 'building' : 'chart-line'}
              ...
              <p className='text-white/70 text-base sm:text-lg md:text-xl max-w-prose leading-relaxed mx-auto'>
                Join Global Edge and start your{' '}
                {selectedRole === 'issuer'
                  ? 'asset tokenization'
                  : 'investment'}{' '}
                journey.{' '}
              ...
              >
                {isSubmitting ? (
                  ...
                  <>
                    ...
                    />
                    Create {selectedRole === 'issuer' ? 'Issuer' : 'Investor'}{' '}
                    Account
                  </>
                )}
              </button>
