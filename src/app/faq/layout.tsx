...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Frequently asked questions about The Global Edge platform, VARA compliance, asset tokenization, and investor onboarding.',
    keywords:
      'FAQs, tokenization platform questions, VARA compliance, asset tokenization, investor onboarding, platform questions, tokenization FAQ, RWA questions',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://theglobaledge.io/og-faq.jpg',
          width: 1200,
          height: 630,
          alt: 'FAQs | Tokenization Platform Questions | The Global Edge',
        },
      ],
    },
    twitter: {
