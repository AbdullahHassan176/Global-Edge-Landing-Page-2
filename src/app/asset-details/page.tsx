          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            <div className='max-w-3xl md:max-w-4xl text-balance'>
              <div className='flex items-center space-x-3 mb-4'>
                ...
                <span className='bg-green-500 bg-opacity-20 px-3 py-1 rounded-full text-sm font-medium'>
                  Active
                </span>
              </div>
              <h1 className='text-4xl lg:text-5xl font-poppins font-bold mb-6 break-words'>
                Asset Details – Tokenized Real-World Asset
              </h1>
              <p className='text-base sm:text-lg md:text-xl opacity-90 mb-6 max-w-prose leading-relaxed'>
                This VARA-compliant tokenized asset provides fractional
                ownership opportunities with full regulatory compliance and
                transparent investor visibility. Explore our{' '}
                <Link
                  href='/assets'
              ...
              <p className='text-base sm:text-lg md:text-xl opacity-90 mb-8 max-w-prose leading-relaxed'>
                High-performance shipping container on the Asia-Pacific trade
                route with consistent returns and low volatility.
              </p>
                    ...
                    {chartData.data.map((value: number, index: number) => (
                      <div key={index} className='flex flex-col items-center'>
                        <div
                          ...
                          style={{
                            height: `${(value / Math.max(...chartData.data)) * 200}px`,
                          }}
                        ></div>
