...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Detailed information about tokenized real-world assets on The Global Edge platform. View performance metrics, investment details, and risk assessment.',
    keywords:
      'asset details, tokenized assets, real-world assets, investment details, asset performance, RWA tokenization, asset metrics, investment analysis',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://theglobaledge.io/og-asset-details.jpg',
          width: 1200,
          height: 630,
          alt: 'Asset Details | Tokenized Real-World Asset | The Global Edge',
        },
      ],
    },
    twitter: {
...
export default function AssetDetailsLayout({
  ...
  const jsonLd = {
    ...
    mainEntity: {
      ...
      description:
        'Comprehensive details about tokenized real-world assets including performance metrics, investment information, and risk assessment',
      author: {
        '@type': 'Organization',
