...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Complete guide to investing in tokenized real-world assets. Learn about asset types, risk management, tax considerations, and how to get started with Global Edge.',
    keywords:
      'investment guide, tokenized assets, real-world assets, RWA investing, asset tokenization guide, investment education, blockchain investing, tokenized real estate, shipping container investing',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://theglobaledge.io/og-guide.jpg',
          width: 1200,
          height: 630,
          alt: 'Investment Guide | Tokenized Asset Investing | The Global Edge',
        },
      ],
    },
    twitter: {
    ...
    about: [
      {
        ...
        description:
          'Digital representations of real-world assets on blockchain',
      },
      {
        '@type': 'Thing',
