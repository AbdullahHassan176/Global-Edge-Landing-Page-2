            ...
            <div className='text-center'>
              <div className='bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10'>
                ...
                <p className='text-xs text-white/60'>
                  This environment contains sample data and is not connected to
                  production systems
                </p>
              </div>
            </div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
            ...
            <div className='bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105'>
              <div className='text-center'>
                ...
                <p className='text-base text-white/80 mb-6 leading-relaxed'>
                  Access the issuer dashboard to test asset creation, investor
                  management, and branding features.
                </p>
            ...
            <div className='bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105'>
              <div className='text-center'>
                ...
                <p className='text-base text-white/80 mb-6 leading-relaxed'>
                  Access the investor dashboard to test asset browsing,
              ...
              <div className='bg-white/5 rounded-xl p-6 border border-white/10'>
                ...
                <div className='space-y-2 text-sm'>
                  ...
                  <div className='flex items-center text-white/80'>
                    <Icon
                      name='building'
                      className='h-4 w-4 text-white/60 mr-2'
                    />
                    <span className='font-medium'>Company:</span>
                    <span className='ml-2 text-white/90'>
                      Global Edge Demo Holdings
                    </span>
                  </div>
                </div>
              </div>
