        ...
        <div className='relative max-w-7xl mx-auto px-6 lg:px-8 h-full flex items-center'>
          <div className='max-w-6xl text-white text-balance text-left'>
            ...
            <p className='text-base sm:text-lg md:text-xl font-inter font-light opacity-90 mb-6 max-w-6xl leading-relaxed'>
              Simple, transparent pricing with no hidden fees. Pay only for what
              you use with{' '}
              <Link
                href='/assets'
            ...
            <p className='text-base sm:text-lg md:text-xl font-inter font-light opacity-90 max-w-6xl leading-relaxed'>
              As a leading tokenization service provider Dubai, we offer
              comprehensive asset digitization solutions with transparent
              pricing structures. Our VARA-compliant platform enables fractional
              ownership of real-world assets while maintaining regulatory
              compliance and{' '}
              <Link
                href='/investors'
                className='underline hover:text-global-teal transition-colors'
        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center mb-16'>
            <h2 className='text-4xl font-poppins font-bold text-charcoal mb-4'>
              Transparent Pricing for Tokenization
            </h2>
            <p className='text-xl text-gray-600 max-w-3xl mx-auto mb-6'>
              Flexible pricing options for investors of all sizes. Learn about
              our{' '}
              <Link
                href='/how-it-works'
            ...
            <ul className='text-lg text-gray-600 max-w-2xl mx-auto space-y-2 text-left'>
              <li>
                • <strong>Asset Onboarding:</strong> Complete verification,
                documentation, and blockchain deployment
              </li>
              <li>
                • <strong>Investor Management:</strong> KYC/KYB verification,
                portfolio tracking, and reporting tools
              </li>
              <li>
                • <strong>Regulatory Compliance:</strong> VARA compliance
                monitoring and legal framework maintenance
              </li>
            </ul>
          </div>
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg border border-gray-200'>
              <div className='text-center mb-8'>
                ...
                <div className='text-4xl font-poppins font-bold text-global-teal mb-2'>
                  Free
                </div>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg border-2 border-global-teal relative'>
              <div className='absolute -top-4 left-1/2 transform -translate-x-1/2'>
                <span className='bg-global-teal text-white px-4 py-1 rounded-full text-sm font-medium'>
                  Most Popular
                </span>
              </div>
              <div className='text-center mb-8'>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg border border-gray-200'>
              <div className='text-center mb-8'>
                ...
                <p className='text-gray-600 mb-4'>
                  For institutions & large investors
                </p>
                <div className='text-4xl font-poppins font-bold text-global-teal mb-2'>
                  Custom
                </div>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
            <div className='bg-white rounded-2xl p-6 shadow-lg text-center'>
              ...
              <p className='text-sm text-gray-600'>
                One-time fee on asset purchases
              </p>
            </div>
        ...
        <div className='max-w-4xl mx-auto px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600'>
              Everything you need to know about our pricing. Learn about our{' '}
              <Link
                href='/how-it-works'
                className='text-global-teal hover:text-edge-purple transition-colors'
              >
          ...
          <div className='space-y-8'>
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              ...
              <p className='text-gray-600'>
                The free plan includes access to all tokenized assets, basic
                portfolio tracking, email support, and standard transaction
                fees. Perfect for individual investors getting started.
              </p>
            </div>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              ...
              <p className='text-gray-600'>
                ...
                take effect immediately, and we'll prorate any fees accordingly.
              </p>
            </div>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              ...
              <p className='text-gray-600'>
                No hidden fees. All our fees are clearly displayed upfront. You
                only pay the fees shown in our transparent fee structure.
              </p>
            </div>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              ...
              <p className='text-gray-600'>
                ...
                cryptocurrencies including Bitcoin, Ethereum, and USDC for
                investments and subscription payments.
              </p>
            </div>
          </div>
        </div>
      ...
      {showContactModal && (
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
          <div className='bg-white rounded-2xl p-8 max-w-md w-full mx-4'>
            ...
            <div className='space-y-4'>
              <p className='text-gray-600'>
                Get in touch with our sales team for custom pricing and
              ...
              <div className='space-y-3'>
                <div className='flex items-center'>
                  ...
                  <a
                    href={`mailto:${contactConfig.sales.email}?subject=Sales Inquiry`}
                    className='text-global-teal hover:text-edge-purple'
                  >
                ...
                <div className='flex items-center'>
                  ...
                  <a
                    href={`tel:${contactConfig.sales.phone.replace(/\s/g, '')}`}
                    className='text-global-teal hover:text-edge-purple'
                  >
