        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center mb-16'>
            <h2 className='text-4xl font-poppins font-bold text-charcoal mb-4'>
              Why Invest Through The Global Edge
            </h2>
            <p className='text-xl text-gray-600 max-w-3xl mx-auto mb-6'>
              Access institutional-grade investment opportunities with complete
              transparency and blockchain verification. Learn more about our{' '}
              <Link
                href='/get-started'
            ...
            <ul className='text-lg text-gray-600 max-w-2xl mx-auto space-y-2'>
              <li>
                • <strong>Enhanced Liquidity:</strong> Trade tokenized assets
                24/7 with instant settlement and global market access
              </li>
              <li>
                • <strong>Complete Transparency:</strong> Real-time asset
                tracking, blockchain verification, and immutable ownership
                records
              </li>
              <li>
                • <strong>VARA Compliance:</strong> Full regulatory compliance
                with UAE's Virtual Assets Regulatory Authority framework
              </li>
            </ul>
          </div>
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-600'>
                Comprehensive due diligence, insurance coverage, and oracle
                verification for all assets
              </p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-600'>
                Real-time tracking, blockchain verification, and complete audit
                trails for all investments
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Access a wide range of tokenized real-world assets with varying
              risk profiles and return potential. Explore our{' '}
              <Link
                href='/assets'
                className='text-global-teal hover:text-edge-purple transition-colors'
              >
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16'>
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              ...
              <p className='text-gray-600 mb-4'>
                Invest in shipping containers with GPS tracking and verified
                cargo, offering 8-15% APR returns.
              </p>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              ...
              <p className='text-gray-600 mb-4'>
                Commercial and residential properties with rental income streams
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              ...
              <p className='text-gray-600 mb-4'>
                Commodity inventory with verified supply chain data and
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              ...
              <p className='text-gray-600 mb-4'>
                Precious metals and secure storage with insurance coverage and
                stable returns.
              </p>
              <div className='space-y-2 text-sm'>
                <div className='flex justify-between'>
          ...
          <div className='grid md:grid-cols-4 gap-8'>
            <div className='text-center'>
              ...
              <p className='text-sm text-gray-600'>
                Verify your identity with our secure, compliant onboarding
                process
              </p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-sm text-gray-600'>
                Deposit funds securely through our integrated payment systems
              </p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-sm text-gray-600'>
                Explore and analyze tokenized assets with detailed performance
                data
              </p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-sm text-gray-600'>
                Make investments with as little as $50 and track returns in
                real-time
              </p>
            </div>
          </div>
