...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: 'risk disclosures, investment risk awareness, tokenized asset risks, investment transparency, investor education, risk management, investment warnings',
    ...
    openGraph: {
      ...
      type: 'website',
      images: [{ url: 'https://theglobaledge.io/og-risk-disclosures.jpg', width: 1200, height: 630, alt: 'Risk Disclosures | Investment Risk Awareness | The Global Edge' }]
    },
    twitter: {
      ...baseMeta.twitter,
      title: 'Risk Disclosures | Investment Risk Awareness | The Global Edge',
...
export default function RiskDisclosuresLayout({ children }: { children: React.ReactNode }) {
  const jsonLd = {
