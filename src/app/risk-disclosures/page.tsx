...
export default function RiskDisclosuresPage() {
  ...
  return (
    <>
      ...
      <section
        id='risk-disclosures-hero'
        className='bg-gradient-to-br from-red-600 via-orange-500 to-yellow-500 h-[400px] relative overflow-hidden'
      >
        ...
        <div className='relative max-w-7xl mx-auto px-6 lg:px-8 h-full flex items-center'>
          <div className='max-w-3xl md:max-w-4xl text-white text-balance'>
            ...
            <p className='text-base sm:text-lg md:text-xl font-inter font-light opacity-90 mb-6 max-w-prose leading-relaxed'>
              Please read these risk disclosures carefully before investing. All
              investments carry risk of loss. Learn more in our{' '}
              <Link
                href='/faq'
            ...
            <p className='text-base sm:text-lg md:text-xl font-inter font-light opacity-90 max-w-prose leading-relaxed'>
              Investment risk of tokenized assets includes market volatility,
              liquidity constraints, regulatory changes, and technology risks.
              While tokenization provides fractional ownership and enhanced
              accessibility, it also introduces unique risks that traditional
              investments may not have, requiring careful consideration of your
      ...
      <section
        id='risk-warning'
        className='py-12 bg-red-50 border-b-4 border-red-200'
      >
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='bg-white rounded-2xl p-8 shadow-lg border-l-4 border-red-500'>
            <div className='flex items-start space-x-4'>
              ...
              <div>
                <h2 className='text-2xl font-poppins font-bold text-red-800 mb-4'>
                  Important Risk Warning
                </h2>
                <p className='text-red-700 leading-relaxed text-lg'>
                  <strong>
                    Investing in tokenized assets involves significant risks and
                    may result in the loss of your entire investment.
                  </strong>
                  You should carefully consider whether investing in these
                  assets is suitable for you in light of your circumstances,
                  knowledge, and financial resources. Past performance is not
        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto mb-6'>
              All investments carry inherent risks that you should understand.
              Learn more in our{' '}
              <Link
                href='/faq'
            ...
            <ul className='text-lg text-gray-600 max-w-2xl mx-auto space-y-2 text-left'>
              <li>
                • <strong>Market Risk:</strong> Tokenized asset values fluctuate
                based on underlying asset performance, market conditions, and
                investor sentiment
              </li>
              <li>
                • <strong>Liquidity Risk:</strong> Limited secondary market
                trading may result in difficulty selling tokens at desired
                prices or timeframes
              </li>
              <li>
                • <strong>Regulatory Risk:</strong> Changes in VARA regulations
                or international laws may impact tokenized asset operations and
                investor rights
              </li>
            </ul>
          </div>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
            <div className='bg-white rounded-2xl p-8 shadow-lg border-l-4 border-red-500'>
              ...
              <p className='text-gray-600'>
                Asset values may fluctuate due to market conditions, economic
                factors, and supply and demand dynamics. You may lose money even
                if the underlying asset performs well.
              </p>
            </div>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg border-l-4 border-orange-500'>
              ...
              <p className='text-gray-600'>
                Tokenized assets may have limited liquidity. You may not be able
                to sell your tokens quickly or at fair market value, especially
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg border-l-4 border-yellow-500'>
              ...
              <p className='text-gray-600'>
                Changes in laws, regulations, or government policies may
                adversely affect the value of your investments or the platform's
                ability to operate.
              </p>
            </div>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg border-l-4 border-purple-500'>
              ...
              <p className='text-gray-600'>
                Blockchain technology and smart contracts may have bugs,
                vulnerabilities, or technical failures that could result in loss
                of funds or platform disruption.
              </p>
            </div>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg border-l-4 border-blue-500'>
              ...
              <p className='text-gray-600'>
                The failure of service providers, custodians, or other third
                parties could result in loss of your investments or inability to
                access your funds.
              </p>
            </div>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg border-l-4 border-green-500'>
              ...
              <p className='text-gray-600'>
                Platform operations may be disrupted by cyber attacks, system
                failures, or other operational issues that could affect your
                ability to trade or access your investments.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Different asset types carry unique risks you should understand.
              Learn more in our{' '}
              <Link
                href='/faq'
                className='text-global-teal hover:text-edge-purple transition-colors'
          ...
          <div className='space-y-12'>
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              <div className='flex items-center mb-6'>
                ...
                <div>
                  <h3 className='text-2xl font-poppins font-bold text-charcoal'>
                    Shipping Container Risks
                  </h3>
                  <p className='text-gray-600'>
                    Containers are subject to unique operational and market
                    risks
                  </p>
                </div>
              </div>
              <ul className='list-disc list-inside text-gray-700 space-y-2 ml-4'>
                <li>
                  Weather and natural disaster risks that may damage cargo or
                  delay shipments
                </li>
                <li>
                  Port congestion and shipping delays that may affect delivery
                  schedules
                </li>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              <div className='flex items-center mb-6'>
                ...
                <div>
                  ...
                  <p className='text-gray-600'>
                    Property investments carry specific market and operational
                    risks
                  </p>
                </div>
              </div>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              <div className='flex items-center mb-6'>
                ...
                <div>
                  ...
                  <p className='text-gray-600'>
                    Commodity and trade inventory tokens have specific market
                    risks
                  </p>
                </div>
              </div>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              <div className='flex items-center mb-6'>
                <div className='w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mr-6'></div>
                <div>
                  <h3 className='text-2xl font-poppins font-bold text-charcoal'>
                    Vault Asset Risks
                  </h3>
                  <p className='text-gray-600'>
                    Precious metals and secure storage carry specific risks
                  </p>
                </div>
              </div>
              <ul className='list-disc list-inside text-gray-700 space-y-2 ml-4'>
      ...
      <section id='risk-mitigation' className='py-20'>
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              We implement various measures to help mitigate investment risks.
              Learn more in our{' '}
              <Link
                href='/faq'
                className='text-global-teal hover:text-edge-purple transition-colors'
        ...
        <div className='max-w-4xl mx-auto px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600'>
              Consider whether tokenized assets are suitable for your investment
              profile. Learn more in our{' '}
              <Link
                href='/faq'
                className='text-global-teal hover:text-edge-purple transition-colors'
              >
          ...
          <div className='bg-white rounded-2xl p-8 shadow-lg'>
            <h3 className='text-2xl font-poppins font-bold text-charcoal mb-6'>
              These investments may be suitable for investors who:
            </h3>
            <ul className='list-disc list-inside text-gray-700 space-y-3 mb-8'>
              <li>
                Have a high risk tolerance and can afford to lose their entire
                investment
              </li>
              <li>
                Understand the risks associated with tokenized assets and
                blockchain technology
              </li>
              <li>
                Have sufficient financial resources to withstand potential
                losses
              </li>
              <li>
                Are seeking diversification beyond traditional investments
              </li>
              <li>Have a long-term investment horizon</li>
              <li>
                Are comfortable with limited liquidity and secondary market
                trading
              </li>
            </ul>

            <h3 className='text-2xl font-poppins font-bold text-charcoal mb-6'>
              These investments may NOT be suitable for investors who:
            </h3>
            <ul className='list-disc list-inside text-gray-700 space-y-3'>
      ...
      <section id='final-warning' className='py-20 bg-red-50'>
        <div className='max-w-4xl mx-auto px-6 lg:px-8 text-center'>
          <div className='bg-white rounded-2xl p-8 shadow-lg border-2 border-red-200'>
            <div className='w-20 h-20 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-6'></div>
            <h2 className='text-3xl font-poppins font-bold text-red-800 mb-6'>
              Final Risk Warning
            </h2>
            <p className='text-red-700 leading-relaxed text-lg mb-6'>
              ...
              Tokenized assets are complex, high-risk investments that may not
              be suitable for all investors. Past performance is not indicative
              of future results.
            </p>
            <p className='text-red-700 leading-relaxed text-lg'>
              If you are unsure about the suitability of these investments for
              your circumstances, you should seek independent financial advice
              before investing.
            </p>
          </div>
        </div>
      ...
      <section id='risk-contact' className='py-20'>
        <div className='max-w-4xl mx-auto px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl text-gray-600 mb-8'>
            Contact our risk management team for more information. Learn more in
            our{' '}
            <Link
              href='/faq'
              className='text-global-teal hover:text-edge-purple transition-colors'
