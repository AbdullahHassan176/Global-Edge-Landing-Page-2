...
export default function DashboardClient() {
  ...
  const handleBrowseAssets = () => { router.push('/assets'); };
  const handleViewReports = () => { router.push('/reports'); };
  const handleAccountSettings = () => { router.push('/settings'); };
  const handleViewInvestment = (investmentId: string) => { router.push(`/investments/${investmentId}`); };
