            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-gray-600 mt-1'>
                  Submit or update your KYC documents to comply with VARA
                  standards.
                </p>
              </div>
                    ...
                    {status === 'approved' ? (
                      ...
                      <div className='text-center py-8'>
                        ...
                        <p className='text-gray-600 mb-4'>
                          Please upload a new document that meets our
                          requirements.
                        </p>
                      ...
                      <div
                        className={`border-2 border-dashed rounded-xl p-8 text-center transition-colors ${
                          dragOver
                            ? 'border-global-teal bg-global-teal/5'
                            : 'border-gray-300'
                        }`}
                        onDragOver={e => {
                          e.preventDefault();
                      ...
                      >
                        {isUploading ? (
                          ...
                          <div>
                            ...
                            <p className='text-gray-600 mb-4'>
                              Drag and drop your {doc.name.toLowerCase()} here,
                              or click to browse
                            </p>
                            <input
                              type='file'
              ...
              <div className='bg-white rounded-xl shadow-sm p-6 border border-gray-200 mt-8'>
                <div className='text-center'>
                  ...
                  <p className='text-gray-600 mb-6'>
                    All required documents have been uploaded. Our team will
            ...
            <div className='flex items-start'>
              ...
              <div>
                ...
                <p className='text-blue-800 mb-4'>
                  If you're having trouble with the verification process, our
