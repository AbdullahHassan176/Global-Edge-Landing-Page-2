...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Complete your KYC (Know Your Customer) verification to start investing in tokenized assets on The Global Edge platform.',
...
export default function InvestorKYCLayout({ children }: { children: React.ReactNode }) {
  return children;
}
