  ...
  try {
    ...
    switch (action) {
      ...
      case 'log_login':
        ...
        result = await auditIntegration.logLogin(
          loginUserId,
          loginIp,
          loginUserAgent,
          loginSuccess
      ...
      case 'log_logout':
        ...
        result = await auditIntegration.logLogout(
          logoutUserId,
          logoutIp,
          logoutUserAgent
        );
      ...
      case 'log_create':
        ...
        if (
          ...
          return NextResponse.json(
            {
              success: false,
              error: 'userId, entityType, entityId, and details are required',
            },
            { status: 400 }
          );
        }
        result = await auditIntegration.logCreate(
          createUserId,
          createEntityType,
          createEntityId,
          createDetails,
          ...
          return NextResponse.json(
            {
              success: false,
              error:
                'userId, entityType, entityId, details, and changes are required',
            },
            { status: 400 }
          );
        }
        result = await auditIntegration.logUpdate(
          updateUserId,
          updateEntityType,
          updateEntityId,
          updateDetails,
      ...
      case 'log_delete':
        ...
        result = await auditIntegration.logDelete(
          deleteUserId,
          deleteEntityType,
          deleteEntityId,
          deleteDetails
      ...
      case 'log_read':
        ...
        result = await auditIntegration.logRead(
          readUserId,
          readEntityType,
          readEntityId,
          readDetails
      ...
      case 'log_system_event':
        ...
        result = await auditIntegration.logSystemEvent(
          systemEvent,
          systemDetails,
          systemSeverity
        );
      ...
      case 'log_security_event':
        ...
        result = await auditIntegration.logSecurityEvent(
          securityEvent,
          securityDetails,
          securityUserId,
          securitySeverity
        ...
        return NextResponse.json(
          {
            success: false,
            error:
              'Invalid action. Use: log_event, log_login, log_logout, log_create, log_update, log_delete, log_read, log_system_event, or log_security_event',
          },
          { status: 400 }
        );
    }
