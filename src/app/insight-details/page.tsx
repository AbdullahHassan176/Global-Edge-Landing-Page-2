...
const mockInsights: Insight[] = [
  {
    ...
    description:
      'Exploring how tokenization is revolutionizing global trade and creating new investment opportunities.',
    image:
  ...
  },
  {
    ...
    description:
      'How blockchain technology is enabling secure and transparent trade finance operations worldwide.',
    image:
      'https://storage.googleapis.com/uxpilot-auth.appspot.com/737a82cfea-8505609552f3f2bb8533.png',
    date: '2024-12-14',
    readTime: '7 min read',
  ...
  },
  {
    ...
    description:
      'Strategic approaches to incorporating trade assets into your investment portfolio for better risk management.',
    image:
      'https://storage.googleapis.com/uxpilot-auth.appspot.com/737a82cfea-8505609552f3f2bb8533.png',
    date: '2024-12-13',
    readTime: '6 min read',
      ...
      <div className='bg-white border-b border-gray-100'>
        <div className='max-w-7xl mx-auto px-6 lg:px-8 py-4'>
          <nav className='flex items-center space-x-2 text-sm'>
            <Link
              href='/insights'
              className='text-gray-500 hover:text-global-teal'
            >
              Insights
            </Link>
        ...
        <div className='max-w-4xl mx-auto px-6 lg:px-8'>
          <div className='text-center mb-12 max-w-3xl md:max-w-4xl mx-auto text-balance'>
            ...
            <p className='text-base sm:text-lg md:text-xl text-gray-600 mb-8 max-w-prose mx-auto leading-relaxed'>
              Discover more insights about blockchain compliance, RWA
              tokenization, and asset innovation. Explore our{' '}
              <Link
                href='/insights'
              ...
              for comprehensive analysis and expert perspectives.
            </p>
