...
export default function LoginPage() {
  ...
  const handleGitHubLogin = async () => {
    ...
    try {
      ...
      setError(
        'GitHub login failed. Please try again or use email/password login.'
      );
  ...
  const handleLinkedInLogin = async () => {
    ...
    try {
      ...
      setError(
        'LinkedIn login failed. Please try again or use email/password login.'
      );
      setOauthLoading(null);
    }
  };
      ...
      <div className='min-h-screen bg-gradient-to-br from-global-teal via-blue-50 to-edge-purple flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden'>
        ...
        <div className='sm:mx-auto sm:w-full sm:max-w-md relative z-10'>
          <div className='flex justify-center mb-8'>
            <Link
              href='/'
              className='flex items-center bg-white/90 backdrop-blur-sm px-6 py-3 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300'
            >
              ...
              <span className='text-2xl font-poppins font-bold text-charcoal'>
                Global Edge
              </span>
            </Link>
          </div>
        ...
        <div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10'>
                      ...
                      {(error.includes('pending admin approval') ||
                        ...
                        <div className='mt-3 text-xs text-yellow-300'>
                          <p>
                            ...
                            info@theglobaledge.io or +971 50 123 4567
                          </p>
                        </div>
                      )}
                    </div>
          ...
          <div className='mt-8 text-center'>
            <p className='text-white/80 text-sm'>
              ...
              <Link
                href='/register'
                className='font-semibold text-white hover:text-global-teal transition-colors'
              >
                Create one here
              </Link>
            </p>
