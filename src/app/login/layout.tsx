...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: 'login, secure access, Global Edge platform, tokenized asset dashboard, investor tools, portfolio insights, user authentication',
    ...
    openGraph: {
      ...
      type: 'website',
      images: [{ url: 'https://theglobaledge.io/og-login.jpg', width: 1200, height: 630, alt: 'Login | Secure Access to The Global Edge Platform' }]
    },
    twitter: {
      ...baseMeta.twitter,
      title: 'Login | Secure Access to The Global Edge Platform',
