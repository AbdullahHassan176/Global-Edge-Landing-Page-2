...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Download detailed performance reports, portfolio analytics, tax reports, and transaction history for your tokenized asset investments.',
    keywords:
      'investment reports, portfolio analytics, performance reports, tax reports, transaction history, risk analysis, investment documentation',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://theglobaledge.io/og-reports.jpg',
          width: 1200,
          height: 630,
          alt: 'Investment Reports | Portfolio Analytics | The Global Edge',
        },
      ],
    },
    twitter: {
...
export default function ReportsLayout({
  ...
  const jsonLd = {
    ...
    mainEntity: {
      ...
      description:
        'Comprehensive reporting tools for investment portfolio analysis',
      author: {
        '@type': 'Person',
