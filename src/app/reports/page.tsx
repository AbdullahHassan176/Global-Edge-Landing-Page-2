          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6'>
            ...
            <div className='bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-600 mb-4'>
                Complete overview of your investment portfolio performance
              </p>
            ...
            <div className='bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-600 mb-4'>
                Detailed performance metrics for each asset in your portfolio
              </p>
              <div className='space-y-2 mb-4'>
                <div className='flex justify-between text-sm'>
            ...
            <div className='bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-600 mb-4'>
                Annual tax summary for your investment activities
              </p>
              <div className='space-y-2 mb-4'>
                <div className='flex justify-between text-sm'>
                  <span>Tax Year:</span>
            ...
            <div className='bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow border-2 border-dashed border-global-teal'>
              ...
              <p className='text-gray-600 mb-4'>
                Create a personalized report with your specific requirements and
                preferences
              </p>
              <Link
                href='/reports/custom'
