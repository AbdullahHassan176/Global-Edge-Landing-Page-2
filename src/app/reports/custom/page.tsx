  ...
  const generateReport = async () => {
    ...
    try {
      ...
      if (config.format === 'CSV') {
        ...
        const csvContent = ReportGenerator.generateCSV(
          reportData.data,
          headers
        );
      ...
      <section className='py-20'>
        <div className='max-w-6xl mx-auto px-6 lg:px-8'>
                  ...
                  {[
                    ...
                    >
                      <input
                        ...
                        checked={
                          config[
                            option.key as keyof CustomReportConfig
                          ] as boolean
                        }
                        onChange={e =>
                          setConfig(prev => ({
              ...
              {previewData ? (
                    ...
                    <div className='grid grid-cols-2 gap-4 text-sm'>
                      ...
                      <div>
                        ...
                        <span className='ml-2 font-medium text-green-600'>
                          {previewData.summary?.averageReturn}%
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className='text-center py-12'>
                  ...
                  <p className='text-gray-500'>
                    Generate a preview to see your report configuration
                  </p>
                </div>
              )}
          ...
          <div className='text-center mt-12'>
            <Link
              href='/reports'
              className='bg-gray-600 text-white px-8 py-4 rounded-full font-poppins font-semibold text-lg hover:bg-gray-700 transition-colors mr-4'
            >
              Back to Reports
            </Link>
            <Link
