        ...
        <div className='relative max-w-7xl mx-auto px-6 lg:px-8 h-full flex items-center'>
          <div className='max-w-7xl text-white text-balance text-left'>
            ...
            <p className='text-base sm:text-lg md:text-xl font-inter font-light opacity-90 max-w-6xl leading-relaxed'>
              Our data protection UAE framework ensures comprehensive privacy
              safeguards for all users of The Global Edge platform. We implement
              industry-leading security measures and comply with international
              data protection standards to safeguard your personal information
              and investment data.
            </p>
          </div>
        </div>
          ...
          <div className='bg-white rounded-2xl shadow-lg p-8'>
            <div className='mb-8'>
              ...
              <p className='text-gray-700 leading-relaxed'>
                This Privacy Policy describes how Global Edge collects, uses,
                and protects your personal information when you use our platform
                and services. Please also review our{' '}
                <Link
                  href='/terms'
            ...
            <div className='space-y-12'>
              ...
              <div>
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  ...
                  information. Learn more about our{' '}
                  <Link
                    href='/security'
                    className='text-global-teal hover:text-edge-purple transition-colors'
                  >
              ...
              <div>
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>
                  ...
                  platform. Your continued use of our services after changes
              ...
              <div>
                ...
                <div className='bg-gray-50 rounded-lg p-6'>
                  <p className='text-gray-700'>
                    <strong>{businessConfig.companyName} Privacy Team</strong>
                    <br />
                    Email: {contactConfig.privacy.email}
                    <br />
                    Phone: {contactConfig.privacy.phone}
                    <br />
      ...
      <section id='data-protection-rights' className='py-20 bg-gray-50'>
        <div className='max-w-4xl mx-auto px-6 lg:px-8'>
          ...
          <p className='text-xl text-gray-600 mb-8 text-center'>
            Understand your rights regarding personal data. Learn about our{' '}
            <Link
              href='/terms'
              className='text-global-teal hover:text-edge-purple transition-colors'
            >
          ...
          <div className='grid md:grid-cols-2 gap-8'>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              ...
              <p className='text-gray-600'>
                You can request correction of inaccurate or incomplete personal
                information.
              </p>
            </div>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              <div className='flex items-center mb-6'>
                <div className='w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mr-4'></div>
                <h3 className='text-xl font-poppins font-semibold text-charcoal'>
                  Right to Erasure
                </h3>
              </div>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg'>
              <div className='flex items-center mb-6'>
                <div className='w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mr-4'></div>
                <h3 className='text-xl font-poppins font-semibold text-charcoal'>
                  Right to Portability
                </h3>
              </div>
              <p className='text-gray-600'>
                You can request transfer of your personal information to another
                service provider.
              </p>
            </div>
          </div>
