...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Check real-time uptime and system maintenance updates for The Global Edge tokenization platform.',
    keywords:
      'platform status, uptime, maintenance, system status, tokenization platform, real-time status, service monitoring, system updates, platform health',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://theglobaledge.io/og-status.jpg',
          width: 1200,
          height: 630,
          alt: 'Platform Status | Uptime & Maintenance | The Global Edge',
        },
      ],
    },
    twitter: {
...
export default function StatusLayout({
  ...
  const jsonLd = {
    ...
    mainEntity: {
      ...
      description:
        'System uptime and service announcements for The Global Edge platform',
      author: {
        '@type': 'Organization',
