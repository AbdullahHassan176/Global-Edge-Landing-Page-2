...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Withdraw your earnings and available funds to your bank account securely with The Global Edge platform.',
    keywords:
      'withdraw funds, withdrawal request, bank transfer, secure withdrawal, earnings withdrawal, fund transfer',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://theglobaledge.io/og-withdraw.jpg',
          width: 1200,
          height: 630,
          alt: 'Withdraw Funds | Secure Withdrawal | The Global Edge',
        },
      ],
    },
    twitter: {
...
export default function WithdrawLayout({
  ...
  const jsonLd = {
    ...
    mainEntity: {
      ...
      description:
        'Secure withdrawal of investment earnings and available funds',
      author: {
        '@type': 'Person',
