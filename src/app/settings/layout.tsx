...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Manage your account settings, security preferences, notification settings, and investment preferences on The Global Edge platform.',
    keywords:
      'account settings, security settings, notification preferences, investment preferences, user preferences, account management',
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://theglobaledge.io/og-settings.jpg',
          width: 1200,
          height: 630,
          alt: 'Account Settings | Security & Preferences | The Global Edge',
        },
      ],
    },
    twitter: {
