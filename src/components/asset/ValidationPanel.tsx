      ...
      <div className='p-4 border-b border-gray-200'>
        <div className='flex items-center justify-between'>
          <div className='flex items-center'>
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center mr-3 ${getScoreColor(validation.score)}`}
            >
          ...
          <div className='flex items-center space-x-2'>
            <div
              className={`px-3 py-1 rounded-full text-sm font-medium ${getScoreColor(validation.score)}`}
            >
              ...
              <div>
                {validation.errors.length === 0 ? (
                  <div className='text-center py-8'>
                    <Icon
                      name='check-circle'
                      className='text-green-500 text-4xl mx-auto mb-2'
                    />
                    <p className='text-green-600 font-medium'>
                      No errors found!
                    </p>
                    <p className='text-gray-600 text-sm'>
                      This step is ready to proceed.
                    </p>
                  </div>
                ) : (
                  <div className='space-y-3'>
                        ...
                        <div className='flex items-start'>
                          ...
                          <div className='flex-1'>
                            <div className='flex items-start justify-between mb-2'>
                              ...
                              <span
                                className={`px-2 py-1 rounded-full text-xs font-medium whitespace-nowrap ${getPriorityColor(suggestion.priority)}`}
                              >
                                {suggestion.priority}
                              </span>
                            </div>
            ...
            {validation.score < 70 && (
              <div className='mt-3 p-2 bg-yellow-100 border border-yellow-200 rounded'>
                <p className='text-xs text-yellow-800'>
                  ⚠️ Consider improving this step before proceeding for better
                  approval chances.
                </p>
              </div>
            )}
