          ...
          <div className='space-y-4'>
            <div>
              ...
              <input
                ...
                onChange={e =>
                  handleInputChange('publishableKey', e.target.value)
                }
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-global-teal focus:border-transparent ${
          ...
          <div className='space-y-4'>
            ...
            <div>
              ...
              <input
                ...
                onChange={e =>
                  handleCredentialChange('webhook', e.target.value)
                }
                className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-global-teal focus:border-transparent'
                placeholder='https://hooks.slack.com/services/...'
              />
        ...
        return (
          <div className='text-center py-8'>
            ...
            <p className='text-gray-600'>
              No specific configuration required for this integration type.
            </p>
          </div>
        );
    }
              ...
              <div className='text-right'>
                ...
                {integration.healthCheck && (
                  <p className='text-xs text-gray-500 mt-1'>
                    Last check:{' '}
                    {new Date(
                      integration.healthCheck.lastCheck
                    ).toLocaleString()}
                  </p>
                )}
              </div>
