...
export default function SettingsBackupModal({
  ...
  const [activeTab, setActiveTab] = useState<'backups' | 'export' | 'import'>(
    'backups'
  );
            ...
            <div className='space-y-6'>
              <div className='text-center py-8'>
                ...
                <p className='text-gray-600 mb-6'>
                  Download a JSON file containing all your current settings and
                  integrations.
                </p>
                <button
                ...
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-yellow-700'>
                      The exported file contains sensitive information like API
                      keys and credentials. Keep it secure and don't share it
                  ...
                  {importResult && (
                    ...
                    >
                      <div className='flex items-center'>
                        <Icon
                          name={
                            importResult.success ? 'check-circle' : 'x-circle'
                          }
                ...
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-red-700'>
                      Importing settings will overwrite your current
                      configuration. Make sure to create a backup before
                      importing.
                    </p>
                  </div>
                </div>
