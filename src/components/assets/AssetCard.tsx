    ...
    >
      <div className='relative'>
        ...
        <div className='absolute top-4 left-4 flex space-x-2'>
          <span
            className={`text-xs font-medium px-2 py-1 rounded-full ${getTypeColor(asset.type)}`}
          >
            {asset.type.toUpperCase()}
          </span>
          <span
            className={`text-xs font-medium px-2 py-1 rounded-full ${getStatusColor(asset.status)}`}
          >
      ...
      <div className='p-6'>
        <div className='flex items-center justify-between mb-3'>
          ...
          <div className='text-right'>
            <div className='text-2xl font-poppins font-bold text-global-teal'>
              {asset.apr}%
            </div>
        ...
        <div className='mb-4'>
          <div className='flex justify-between text-sm mb-1'>
            ...
            <span className='font-semibold'>
              $
              {(
                (asset.totalValue * asset.fundedPercentage) /
                100
              ).toLocaleString()}{' '}
